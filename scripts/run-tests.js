...
const SUITES = {
  offline: [
    ...
    ['scripts/test/ced-unit5-contract.test.js', 'Unit 5 canonical/runtime CED coverage'],
    ['scripts/test/unit5-instructional-coherence.test.js', 'Unit 5 cross-surface traceability + assessment alignment'],
