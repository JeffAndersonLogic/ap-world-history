...
module.exports = {
  ...
  deck: `China was never colonized. Argentina had been independent since the <span class="num">1810</span>s. Neither appears in a European color on a map of <span class="num">1900</span>, and in both, foreigners set the tariff or built the railways, held the debt, and could not be tried in local courts. This chapter is about the kind of power that does not show up on the map, why it was often preferred to conquest, and how to prove it is there.`,
