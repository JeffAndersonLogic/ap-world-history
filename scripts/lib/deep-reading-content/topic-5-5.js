...
module.exports = {
  ...
  empires: [
    ...
    // ── 02 ────────────────────────────────────────────────────────────────────
    {
      ...
      thesis: `Two changes in the middle of the century removed the remaining ceilings. One made the strongest available structural material cheap enough to use by the mile, and the other separated the movement of information from the movement of things for the first time in history.`,
      parts: [
        {
        ...
        },
        {
          ...
          blocks: [
            { p: `Before <span class="num">1844</span>, information traveled at the speed of the fastest available transport, which meant a message from London to Calcutta took months. Samuel Morse's line between Washington and Baltimore in <span class="num">1844</span> ended that, and the network spread along the railways, which is not a coincidence: railways needed telegraphs to signal whether a single-track section was clear, and telegraphs needed the railway's cleared, patrolled right of way to run wire along.` },
      ...
      useThis: {
        tool: `Separating information from transport. <em>The mechanism is that for the whole of history before 1844 a message could travel no faster than a person carrying it, so all commerce and administration at a distance ran on stale information and had to delegate authority to compensate, and an electrical signal breaks that constraint, allowing prices, orders and news to arrive in advance of any ship and centralizing decisions that distance had previously devolved.</em>`,
        ...
        comparison: `Against the <em>Mongol yam</em> in Topic 2.2: a relay of horses and stations was the fastest information system of its era and still moved at the speed of a rider, so the yam and the Roman post differ from each other in degree and from the telegraph in kind. That distinction is what makes 1844 a genuine break rather than an improvement.`
      },
      terms: [
        ...
        ['Telegraph', 'Electrical signaling from 1844, which for the first time moved information faster than goods or people.'],
  ...
  closing: {
    ...
    pairs: [
      ...
      {
        category: 'Change',
        title: '1844 is the first time information outran transport',
        body: `For the whole of this course before the telegraph, a message moved at the speed of the fastest rider or ship, so the Mongol yam and the Roman post differ in degree and not in kind, and every distant administration had to delegate authority to compensate for stale information. Morse&rsquo;s Washington to Baltimore line in 1844, the Channel cable in 1851 and the durable transatlantic cable of 1866 broke that. By the 1870s a London merchant knew a Bombay price the same day, which let commodity prices converge worldwide, made futures markets workable, and let an order from London reach a colonial governor in hours, centralizing decisions that distance had previously devolved.`
      },
      {
      ...
      },
      {
        ...
        body: `Industrial cities had to be fed from soils cropped harder than ever, and Europe was short of nitrogen, so from the 1840s Peru exported seabird excrement from rainless Pacific islands on an enormous scale. It was dug in choking ammoniac dust substantially by indentured Chinese laborers, perhaps ninety thousand or more, recruited by deception and worked at a mortality that produced diplomatic complaint. Peru borrowed against the revenue and built railways on guano-backed debt; the deposits ran out; attention shifted to Atacama nitrates, which produced the War of the Pacific in 1879 and Chilean control of the territory; Peru defaulted; and Haber-Bosch nitrogen fixation from 1909 made the commodity irrelevant. Resource boom, coerced migrant labor, debt dependency, a war over raw materials, and obsolescence.`
      }
    ]
  }
};
