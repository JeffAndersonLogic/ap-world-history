...
/**
 * Canonical Deep Reading source for Topic 2-1.
  ...
  "empires": [
    {
      ...
      "terms": [
        [
          "Pax Mongolica",
          "The century of relative security along the overland routes under related Chinggisid regimes, which reduced tolls and made a journey calculable without ever being one government."
        ],
        [
          "Khanbaliq",
          "The Yuan capital, modern Beijing, and the eastern terminus of the overland trade in this period."
        ],
        [
          "Tabriz",
          "The Ilkhanate&rsquo;s commercial capital in northwestern Persia, where the eastern routes met the roads to the Mediterranean and Black Sea."
        ],
        [
          "Kaffa",
          "The Genoese trading colony in the Crimea, the western end of the northern route, and the point at which plague entered the Mediterranean in 1347."
        ],
        [
          "Oasis city",
          "A settlement such as Kashgar or Samarkand whose water made it a compulsory stop, and whose rulers therefore lived on provisioning and taxing caravans."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Value density",
          "Value per unit of weight; the ratio that decides whether a good is worth moving on an expensive route."
        ],
        [
          "Bactrian camel",
          "The two-humped Central Asian camel, able to carry about two hundred kilograms across cold and arid terrain that would kill other pack animals."
        ],
        [
          "Paiza",
          "An inscribed metal tablet issued by Mongol authority entitling the bearer to use the relay system and demand mounts and supplies."
        ],
        [
          "Trading diaspora",
          "A merchant community with relatives or co-religionists settled at nodes along a route, which made contracts enforceable where no shared court existed."
        ],
        [
          "Caravan",
          "A traveling company of merchants, animals, drivers, guards and a guide, best understood as a temporary joint venture sharing costs and risk."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Caravanserai",
          "A fortified inn with stabling and storage, placed about a day&rsquo;s travel apart, often funded by a charitable endowment and free for a short stay."
        ],
        [
          "Waqf",
          "An Islamic charitable endowment whose revenues fund an institution in perpetuity, and which paid for many caravanserais, madrasas and hospitals."
        ],
        [
          "Qirad",
          "The partnership in which one party supplies capital and the other the travel and trading, with profits split by prior agreement; the Italian commenda is the same instrument."
        ],
        [
          "Sakk",
          "A written order to pay, allowing value to move between cities without shipping coin; the ancestor of the word check."
        ],
        [
          "Ortoq",
          "A merchant association financed by Mongol nobles who shared in its profits, making the ruling elite direct investors in the trade they protected."
        ],
        [
          "Yam",
          "The Mongol relay post system of stations with horses and supplies, reserved for official messengers rather than merchants."
        ]
      ]
    },
    {
      ...
      "num": "04",
      "accent": "oxide",
      "name": "Demand and Productive Response",
      "navLabel": "Demand and production",
      ...
      "parts": [
        {
          "heading": "Luxury demand supplied the incentive",
          "blocks": [
            {
        ...
        {
          "heading": "Producers responded to distant markets",
          "blocks": [
            {
            ...
            },
            {
              "note": {
                "kind": "misconception",
                "label": "Common mistake to avoid",
                "html": "Do not reduce the topic to a cargo list. A named good becomes useful evidence only when you connect demand to merchant incentive or connect expanding markets to increased productive capacity."
              }
            }
          ]
        }
      ...
      "terms": [
        [
          "Luxury demand",
          "Demand for scarce, high-value goods strong enough to justify expensive interregional transport."
        ],
        [
          "Productive capacity",
          "The ability of an economy to produce goods; expanding markets can encourage that capacity to grow."
        ],
        [
          "Porcelain",
          "A high-value Chinese manufactured good produced in greater quantities for expanding export markets."
        ],
        [
          "Textiles",
          "Major Chinese, Persian and Indian exports whose production expanded with interregional demand."
        ],
        [
          "Iron and steel",
          "Chinese manufactured output that the CED identifies as expanding alongside wider economic growth."
        ]
      ]
    },
    {
      ...
      "num": "05",
      "accent": "gold",
      "name": "Cities and the Feedback Loop",
      "navLabel": "Cities and the feedback loop",
      ...
      "parts": [
        {
          "heading": "Kashgar and Samarkand were commercial nodes",
          "blocks": [
            {
        ...
        {
          "heading": "The system reinforced itself",
          "blocks": [
            {
      ...
      "terms": [
        [
          "Kashgar",
          "A major Central Asian trading city near the Tarim Basin where routes converged and merchants connected east-west corridors."
        ],
        [
          "Samarkand",
          "A major Central Asian commercial city whose strategic location made it an important node in overland exchange."
        ],
        [
          "Trade volume",
          "The quantity of exchange moving through a network."
        ],
        [
          "Geographic range",
          "The spatial reach of a network and the regions regularly linked through exchange."
        ],
        [
          "Feedback loop",
          "A process in which network growth strengthens cities and production, which in turn makes further exchange easier or more profitable."
        ]
      ]
    }
  ],
