 ...
 * room for one. Success criterion 1 asks for a specific sentence about each of
 * six regions plus the Foundations theme that explains it; success criterion 2
 * asks a student to explain each of the five thinking skills in their own words
 * and say where it appeared in Days 1 to 4. A survey can do the snapshots or the
 * skills. It cannot do both and still be specific enough to cite.
 *
 * So the chapter has two halves and says so. Sections 01 to 06 are the regions,
 * every one on the same four parts, the last of which names the theme and argues
 * for it rather than asserting it. Sections 07 to 09 are the skills: the five
 * moves with an example drawn from an earlier Foundations day and the failure
 * mode for each, then periodization, which is here because the lesson's own term
 * table lists it and nothing else in the topic teaches it, and finally an SAQ
 * paragraph built in front of the student.
 *
 * Two things this chapter is written to prevent, both of which are easy to walk
 ...
 *      into a single confident moment.
 *
...
module.exports = {
  ...
  howTo: {
    ...
    intro: `This chapter has two halves and they do different work. Sections 01 to 06 are the regional baseline, each on the same four parts, ending with the Foundations theme that best explains that region and an argument for why. Sections 07 to 09 are the analytical half: the five thinking skills, then why the course starts where it does, then an SAQ paragraph built one sentence at a time.`,
    steps: [
  ...
  empires: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { note: {
              ...
              html: `Do not write that Song China had "the civil service exam" as though it were new, and do not credit it to Confucius or the Han. The examination system developed under the Sui and Tang; the Song expanded it dramatically and made it the ordinary route into office. Similarly, do not write that the Song "invented paper money" without qualification: the notes began as private merchant instruments in Sichuan and the state took over issue afterwards. Both corrections cost one clause and both are the kind of precision an examiner notices.`
            } }
          ]
        }
      ],
    ...
    // ── 02 ────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        {
          heading: 'The snapshot',
          blocks: [
            { p: `The Abbasid caliph in Baghdad retains religious prestige and very little else; real power in the central lands has belonged to Turkish dynasties since the eleventh century, and the Seljuk inheritance has fractured into competing successor states. Egypt and Syria are under the Ayyubids founded by Saladin, who died in <span class="num">1193</span> after retaking Jerusalem from the crusader kingdoms. The Maghrib and what remains of Muslim Iberia are under the Almohads. Ghurid armies out of Afghanistan have defeated their opponents in northern India and are about to establish a sultanate at Delhi.` },
            { p: `Intellectually the same decades are a peak. Ibn Rushd, known in Latin Europe as Averroes, dies in <span class="num">1198</span> having written the commentaries on Aristotle that Latin scholars will spend the next century arguing about. Maimonides, a Jewish philosopher and physician writing in Arabic, dies in Cairo in <span class="num">1204</span>. That one sentence is worth pausing on: the most important Jewish philosopher of the period wrote in the language of Islamic scholarship, which tells you what kind of world this was.` }
          ]
        },
        {
          heading: 'What holds it up',
          blocks: [
            { p: `The institution to name is the <span class="kt">waqf</span>, the permanent endowment. A person could dedicate the revenue of a property irrevocably to a school, hospital, fountain or mosque, and because the endowment was legally inalienable it funded that institution regardless of who currently ruled the city. The <span class="kt">madrasa</span> network ran on this, which is precisely why scholarship survived, and expanded, through two centuries of political collapse and reconquest. Institutions that do not depend on a treasury do not fall when a dynasty does.` },
            { p: `Around it, three connective tissues. Shared law, so a contract or a marriage or an inheritance was adjudicated on recognizably common principles from Córdoba to Samarkand. Arabic as the language of scholarship and much of commerce, which meant a book written in one city could be read across the whole zone. And the <span class="kt">hajj</span>, which assembled people from every corner of that world annually and carried news, students, goods and manuscripts along with them.` },
            { p: `Paper underpins all of it, which is the direct link back to Foundations 4. Cheap writing material made large libraries, working bureaucracies, and a book trade possible.` }
          ]
        },
        {
          heading: 'The pressure on it',
      ...
      terms: [
        ...
        ['Ibn Rushd', 'The Andalusi philosopher (died 1198) whose Aristotle commentaries shaped later Latin European thought.']
      ]
    },
      ...
      parts: [
        {
          heading: 'The snapshot',
          blocks: [
            { p: `On the east coast, the Swahili city-states, among them Kilwa, Mombasa and Mogadishu, are Indian Ocean ports: Muslim, Swahili-speaking, stone-built, exporting gold and ivory from the interior and importing Chinese porcelain, Persian glass and Indian cloth. Kilwa is rising toward the dominance of the southern trade that its later monuments record.` },
            { p: `Inland from the Mozambique coast, on the Zimbabwe plateau, the great stone enclosures of <span class="kt">Great Zimbabwe</span> are being built by a state whose wealth rests on cattle, on gold and on the route down to the coast. In West Africa, Ghana's power is gone, Mali's has not yet arrived, and the Sahel is in the unsettled interval between them, with the Sosso dominant and Sundiata's founding of Mali still a generation ahead. Around Lake Chad, Kanem is a substantial state on the eastern trans-Saharan routes.` },
            { p: `In the northeast, Christian Ethiopia under the Zagwe dynasty is cutting the rock-hewn churches at Lalibela, traditionally dated to about this moment. Egypt and the Maghrib belong to the story in section 02.` }
          ]
        },
        {
          heading: 'What holds it up',
          blocks: [
            ...
            { note: {
              ...
              html: `Most written accounts of West Africa in this period come from outsiders writing in Arabic, often at a distance: al-Bakri described Ghana's capital in <span class="num">1068</span> without going there. For the interior states, archaeology and oral tradition carry more of the weight, and both come with their own conventions. Great Zimbabwe is the sharpest case of what happens when evidence is read through prejudice: European commentators in the colonial period insisted the stonework must have been built by outsiders, a claim archaeology has thoroughly refuted and which survived as long as it did because of who was making it. Cite the site with confidence, and cite the controversy as an example of how the identity of the interpreter shapes the interpretation.`
            } }
          ]
        },
        {
        ...
        },
        {
          heading: 'Which theme explains it',
          blocks: [
            { p: `<b>Trade networks</b>, decisively. The condition of every African polity in this snapshot follows from which network it touched and where it sat on it. The follow-up that makes an answer strong is to name the second-order effect: the trade brought Islam to the Sahel and the Swahili coast, which brought literacy, written law and a place in a wider commercial community, which then reinforced the trade. Belief systems and trade networks are not competing explanations here. One arrived on the other.` }
          ]
        }
      ],
      useThis: {
        tool: `Control of the exchange point. <em>The mechanism is that a state positioned where interior production met a long-distance network could tax everything passing through without producing any of it, which is why Kilwa's wealth came from commanding the outlet for interior gold and Ghana's came from levying salt inbound and gold outbound.</em>`,
        limit: `That wealth depended on a route staying where it was. Ghana's collapse and the interval before Mali show how quickly a state built on taxing an exchange can lose its basis.`,
        comparison: `Against <em>the Americas</em> on connection, which is your second reading question: both had long-distance exchange, and only one was plugged into Afro-Eurasia. The closing works this through. Against <em>Song China</em> on taxing trade rather than production.`
      },
      terms: [
        ['Swahili city-states', 'The Muslim, Swahili-speaking ports of the East African coast, linking the interior to the Indian Ocean.'],
        ['Great Zimbabwe', 'The stone-built state on the Zimbabwe plateau, whose wealth rested on cattle, gold and the route to the coast.'],
        ['Kanem', 'A substantial state around Lake Chad, positioned on the eastern trans-Saharan routes.'],
        ['Zagwe dynasty', 'The Christian Ethiopian dynasty associated with the rock-hewn churches at Lalibela.'],
        ['Sahel', 'The semi-arid belt where trans-Saharan caravan routes met West African river and savanna transport.']
      ]
    },
      ...
      parts: [
        {
          heading: 'The snapshot',
          blocks: [
            { p: `In northern India, Ghurid forces from Afghanistan defeat the Rajput coalition in the early <span class="num">1190s</span> and their commanders establish a sultanate at Delhi in <span class="num">1206</span>. This is the beginning of sustained Muslim political authority in the subcontinent, ruling over a population that remains overwhelmingly non-Muslim, which will be a defining tension of Unit 1. In the south the Chola dynasty, whose naval reach had extended across the Bay of Bengal in the eleventh century, is past its peak.` },
            { p: `In mainland Southeast Asia the Khmer empire is at its height. Angkor Wat, completed around <span class="num">1150</span> as a Hindu temple identifying Suryavarman II with Vishnu, is joined under Jayavarman VII, ruling from about <span class="num">1181</span>, by the new capital at Angkor Thom and a state turn toward Mahayana Buddhism. In the islands and straits, Srivijaya's old dominance has weakened, and the contest for the passage between the Indian Ocean and the South China Sea continues without a single master.` }
          ]
        },
        {
          heading: 'What holds it up',
        ...
        },
        {
          heading: 'Which theme explains it',
          blocks: [
            { p: `<b>Belief systems</b>, if you take Angkor, and the reason is that Hindu and then Buddhist cosmology is doing political work here, not just religious work. A Khmer king identified with a deity gets an argument for his own authority and a reason for tens of thousands of people to build his temple. Foundations 2 explains the mechanism: Hindu kingship traveled to Southeast Asian courts as a legitimacy technology adopted by rulers, without the caste order that structured society in South Asia.` },
            { p: `<b>Trade networks</b>, if you take the straits, for the reasons in section 03 and Foundations 4. Either choice is defensible. What is not defensible is choosing one theme and then writing evidence that supports the other, which is the most common way this question goes wrong.` }
          ]
        }
      ],
      useThis: {
    ...
    // ── 05 ────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        ...
        },
        {
          heading: 'Which theme explains it',
          blocks: [
            { p: `<b>Geography</b>, and it is the clearest theme match in the chapter. Two oceans separated the hemisphere from Afro-Eurasian exchange, and the Americas' own north to south axis runs across climate zones rather than along them, which slows the spread of crops and domesticated animals compared with the long east to west corridor of Eurasia. The absence of large domesticable animals is likewise a fact about which species happened to live where.` },
            { p: `That argument is influential and it is also contested in its strong form, so the version to write is careful: geographic separation from Afro-Eurasia is the decisive condition, and it explains an absence of exchange rather than any absence of achievement.` }
          ]
        }
      ],
      useThis: {
    ...
    // ── 07 ────────────────────────────────────────────────────────────────────
    {
      ...
      accent: 'iron',
      name: 'The Five Moves',
      navLabel: 'The five moves',
      dates: 'Contextualization, causation, continuity and change, comparison, argumentation',
      thesis: `The five AP historical thinking skills are not vocabulary to memorize. They are five things a historian does to a piece of evidence, and you have already done all five in Foundations 1 to 4 without them being named. Each part below defines the move, points to where you already made it, and names the way it is usually done badly.`,
      parts: [
        {
          heading: 'Contextualization',
          blocks: [
            { p: `<b>The move:</b> place the thing you are explaining inside the conditions that shaped it, and state the connection. Contextualization is a zoom out followed by a link back, and the link is the part that earns the point.` },
            { p: `<b>Where you already did it:</b> Foundations 1. You cannot explain Song prosperity without the Yangtze Delta's wet-rice capacity, and section 01 above does exactly that move in two sentences.` },
            { p: `<b>The failure mode:</b> writing an introduction and calling it context. "Song China was a dynasty in East Asia during a period of Confucian tradition" names a background and connects nothing. "Driven south in 1127, the Song court found itself governing the most productive rice region in the world, and taxed the maritime trade that its loss of the north had made essential" names conditions and explains what they produced.` }
          ]
        },
        {
          heading: 'Causation',
          blocks: [
            { p: `<b>The move:</b> explain why something happened by tracing the mechanism from cause to effect. A cause you have named but not traced is an assertion.` },
            { p: `<b>Where you already did it:</b> Foundations 3, in every "how did this tool of rule actually work" question, and Foundations 4, in the monsoon and the camel.` },
            { p: `<b>The failure mode:</b> stopping at the feature. "The monsoon winds caused Indian Ocean trade" is a feature. "The wind reverses in June and again in November, so a round trip took most of a year and merchants overwintered in foreign ports, which produced permanent diaspora communities in every major harbour" is a mechanism. Test yourself with the word <em>because</em>: if the sentence after it repeats the cause instead of explaining how it operated, you have not finished.` }
          ]
        },
        {
          heading: 'Continuity and change over time',
          blocks: [
        ...
        },
        {
          ...
          blocks: [
            { p: `<b>The move:</b> make a defensible claim, support it with specific evidence, and explain the reasoning that links them. Defensible means someone could reasonably disagree, which is what separates a claim from a summary.` },
            { p: `<b>Where you already did it:</b> every checkpoint in Foundations, and every "evaluate this statement" question in the readings.` },
            { p: `<b>The failure mode:</b> answering the topic instead of the question. If the prompt asks you to evaluate whether belief systems mattered more than states, a paragraph describing belief systems has not taken a position. The first sentence should be one you could argue against.` }
          ]
        }
      ],
      useThis: {
        tool: `The five moves as verbs rather than labels. <em>Contextualization links a condition to an outcome; causation traces a mechanism; continuity and change measures against a baseline; comparison puts two cases inside one category; argumentation states a position and defends it. A response that performs three of them well beats one that names all five.</em>`,
        limit: `Each move has a signature failure: an introduction posing as context, a feature posing as a cause, progress posing as change, a parallel list posing as a comparison, and a summary posing as an argument.`,
        comparison: `Set section 07 beside section 09. This one defines the moves; that one shows all of them working inside a single paragraph, which is what an SAQ actually asks for.`
      },
      terms: [
        ['Contextualization', 'Placing a development inside the conditions that shaped it and stating the connection.'],
        ['Causation', 'Explaining why something happened by tracing the mechanism from cause to effect.'],
        ['Continuity and change over time', 'Identifying what changed and what persisted, measured against a baseline.'],
        ['Comparison', 'Explaining similarity or difference between two cases inside one named analytical category.'],
        ['Argumentation', 'A defensible claim, specific evidence, and explicit reasoning connecting the two.']
      ]
    },
    ...
    // ── 08 ───────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        {
          ...
          blocks: [
            ...
            { note: {
              kind: 'misconception',
              label: 'Common mistake to avoid',
              html: `Never write as though something happened <em>in</em> 1200 to start the period. There was no event. Students who treat the boundary as an occurrence end up writing sentences like "in 1200 the world became interconnected," which is false in both directions: Afro-Eurasia had been connected for well over a thousand years, and the Americas were not connected to it in 1200 or for three centuries afterwards. The boundary marks where <em>this course</em> starts looking, and nothing more.`
            } }
          ]
        },
        {
        ...
        {
          heading: 'The case against it, and what it hides',
          blocks: [
            { p: `Every boundary conceals the continuities that run straight through it, and a strong student can name the ones this boundary hides. The Indian Ocean network was already routine when a Greek merchant wrote the <em>Periplus</em> more than a thousand years earlier. The Silk Roads were roughly thirteen centuries old. Every belief system in Foundations 2 predates the line, some by two millennia. The states in Foundations 3 are older still, and their answers to the problems of rule were being copied long after the empires themselves were gone.` },
            { p: `The boundary also fits some regions far better than others. It is a reasonable hinge for Afro-Eurasia. It means very little in the Americas, where the significant discontinuities fall at different moments entirely, and where the change that does reorganize everything arrives in 1492 from outside. Whenever a periodization fits one region and is imposed on another, ask whose history set the frame. That question is not a complaint about the course. It is one of the most reliable ways to get an interesting sentence into an argument.` }
          ]
        },
        {
      ...
      terms: [
        ['Periodization', 'Dividing continuous time into named stretches; always an argument about what the story is about.'],
        ['Circa', 'Approximately, abbreviated c.; a signal that the date is an estimate or a convenience rather than a record.'],
        ['Historical significance', 'A judgment that something mattered because of what it enabled or prevented, and for whom, rather than a property it simply has.'],
        ['Baseline', 'The established starting condition against which later continuity and change is measured.']
      ]
    },
    ...
    // ── 09 ────────────────────────────────────────────────────────────────────
    {
      ...
      num: '09',
      accent: 'gold',
      name: 'Building the Paragraph',
      navLabel: 'Building the paragraph',
      dates: 'Claim, evidence, reasoning, context &nbsp;·&nbsp; one paragraph, four jobs',
      thesis: `An SAQ paragraph is short, and every sentence in it has a job. This section builds one in front of you from the material in this chapter, then shows the weak version of the same paragraph so the difference is visible rather than described.`,
      parts: [
        {
          heading: 'The four jobs',
          blocks: [
            { p: `<b>Sentence one, the claim.</b> Answer the question directly and take a position someone could dispute. Not "there were many important developments in Song China," which nobody would argue with and which answers nothing.` },
            { p: `<b>Sentences two and three, the evidence.</b> Named institutions, people, places, dates or practices. "Trade was important" is not evidence. "Maritime customs revenue collected at Quanzhou" is.` },
            { p: `<b>Sentence four, the reasoning.</b> Explain why the evidence supports the claim, using because, which meant, or as a result. This is the sentence most responses leave out, and it is usually the one carrying the point.` },
            { p: `<b>Somewhere, one contextualization move.</b> Name the condition that made the whole thing possible and link it. It can be folded into the claim sentence or added at the end.` }
          ]
        },
        {
      ...
      useThis: {
        tool: `One job per sentence. <em>Claim that could be disputed, evidence with names and dates, reasoning that explains the link, and one condition named and connected. A four-sentence paragraph that does those four things scores better than a twelve-sentence paragraph that describes.</em>`,
        limit: `The commonest failure is a final sentence that restates the claim rather than reasoning from the evidence to it. Check that sentence last, every time.`,
        comparison: `Set the worked paragraph beside the weak one. Both writers know the same history, and only one of them wrote a claim, named a place and explained a mechanism.`
      },
      terms: [
        ['Claim', 'A defensible position that answers the prompt directly and that someone could reasonably dispute.'],
        ['Evidence', 'Specific named institutions, people, places, dates or practices, rather than general description.'],
        ['Reasoning', 'The sentence explaining why the evidence supports the claim, usually the one carrying the point.'],
        ['SAQ', 'The short answer question: a compact paragraph in which every sentence has a job.']
      ]
    }
  ],
  ...
  closing: {
    ...
    intro: `Your three reading questions ask for a contextualization, a comparison and an argument. All three have evidence in this chapter, and the second one is the easiest in the course to get subtly wrong, so it gets the longest entry.`,
    pairs: [
      {
        category: 'Question 1: Contextualization',
        title: 'Pick the region, then earn the theme',
        body: `Every regional section ends by naming a theme and arguing for it, so use that part as a model rather than as an answer to copy. The scoring shape is two sentences: name the condition, then explain what it produced. For <em>Song China</em>, the loss of the north in 1127 turned a land empire toward the sea and made customs revenue essential. For <em>Dar al-Islam</em>, waqf endowments funded scholarship independently of any treasury, so intellectual life continued through political collapse. For the <em>Americas</em>, separation from Afro-Eurasia meant no draft animals and no shared disease pool. More than one theme is defensible for most regions; what is not defensible is naming one theme and then citing evidence that belongs to another.`
      },
      {
      ...
      },
      {
        ...
        title: 'Why these six snapshots are worth memorizing',
        body: `Every continuity and change question for the rest of the year measures against this moment. When Unit 2 asks what the Mongols changed about Eurasian trade, the answer depends on knowing that the routes were already 1,300 years old and that what the Mongols supplied was political consolidation rather than the network itself. When Unit 4 asks what the Portuguese changed in the Indian Ocean, the answer depends on knowing that a dense, sophisticated commercial system was already running on the monsoon and that they arrived into it rather than opening it. Learn the baseline and half the analytical work of the next eight units is already done.`
      }
    ]
  }
};
