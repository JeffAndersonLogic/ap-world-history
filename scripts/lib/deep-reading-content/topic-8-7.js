      ...
      parts: [
        {
          ...
          blocks: [
            { p: `Gandhi worked the method out in South Africa, not India. From <span class="num">1906</span> he organized Indian residents of the Transvaal against a registration law, and by the time he left for India in <span class="num">1914</span> he had a name for it and a body of practice behind it. Satyagraha translates roughly as holding to truth, and Gandhi insisted it was the opposite of submission: noncooperation, organized and disciplined, carried out in the open by people prepared to be arrested for it.` },
            { p: `The Salt March shows the strategy at the level a student can reuse. In <span class="num">1930</span> the colonial government held a monopoly on the manufacture and sale of salt and taxed it, and Gandhi chose that law rather than a land law or a franchise law for three reasons. Salt is used by everyone, so the tax reached the poorest household in India and the grievance needed no explaining. Breaking the law took no weapon and no organization beyond walking to the coast, so hundreds of thousands of people could do it at once. And a government defending a tax on salt argues from a weak position in front of any audience at all.` },
            { p: `He walked about 240 miles from Sabarmati to the coast at Dandi over twenty-four days and made salt on 6 April <span class="num">1930</span>. Then the dilemma closed. Enforce the law and the state is arresting people for boiling seawater, tens of thousands of them, filling its own jails and its opponents' newspapers. Decline to enforce it and the law is dead and so is the principle that colonial law is obeyed. The British administration chose enforcement, arrested Gandhi in May, and at the Dharasana salt works watched police beat column after column of marchers who did not raise their hands.` },
      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `<b>And the structural case.</b> The CED's fourth example is not a man or a country. In his farewell address in January <span class="num">1961</span> President Eisenhower, a career soldier before he was a politician, warned that a permanent armaments industry combined with a large military establishment created the possibility of unwarranted influence over policy. That claim is about institutional incentives rather than conspiracy: an industry whose customers are governments has a standing interest in the perception of threat, and it employs people in the districts of the legislators who vote on procurement.` },
            { p: `Sitting next to that, and distinct from it, is the arms trade. Both superpowers supplied clients throughout the period, which is the transaction the Topic 8.3 chapter takes apart, and weapons outlast the conflicts they are sent for: Afghanistan, Angola and Central America were all left with arms in circulation after their patrons stopped paying. Keep the two claims separate in an essay, because the first is a contested argument about how policy gets made and the second is a documented fact about supply.` },
            { note: {
              kind: 'howknow',
      ...
      parts: [
        {
          ...
          blocks: [
            ...
            { p: `Its strategy was a rural people's war, and its method against the rural population was terror. It killed local officials, cooperative organizers, aid workers and elected village authorities, on the reasoning that a community with functioning institutions has an alternative to the revolution and must be deprived of one. At Lucanamarca in <span class="num">1983</span> its fighters killed 69 villagers, which Guzman later defended publicly as necessary. In <span class="num">1992</span> it assassinated Maria Elena Moyano, a grassroots organizer in a Lima shantytown who had opposed it openly, and set off a car bomb in a middle-class district of the capital. Guzman was captured later that year and the movement collapsed quickly, which tells you how centralized it had been.` },
