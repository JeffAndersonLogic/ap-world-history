...
/**
 * Canonical Deep Reading source for Topic 2-5.
...
module.exports = {
  ...
  "deck": "Intensified exchange changed culture in three major ways: traditions and technologies diffused across regions, the fortunes of cities changed with trade and productivity, and more travelers wrote accounts of the increasingly connected Afro-Eurasian world.",
  "meta": [
    "Five sections",
    "Diffusion, cities, travel writing",
    "Read alongside the First & 10"
  ],
  "footerNote": "Topic 2.5 &nbsp;·&nbsp; What Traveled Without Paying Freight &nbsp;·&nbsp; Companion to the First &amp; 10",
  "howTo": {
    "heading": "How to Use This",
    "intro": "Section 01 explains how diffusion works. Sections 02 and 03 trace beliefs and technologies. Sections 04 and 05 protect the two developments most easily lost in a generic “things spread” lesson: changing urban fortunes and the growth of written travel accounts.",
    "steps": [
  ...
  "empires": [
    {
      ...
      "terms": [
        [
          "Diffusion",
          "The movement of a practice or technique from one society to another, together with the knowledge required to use it."
        ],
        [
          "Stimulus diffusion",
          "The spread of the knowledge that something is possible, with the receiving society inventing its own method."
        ],
        [
          "Independent invention",
          "The separate development of the same thing in two societies, where no transmission occurred."
        ],
        [
          "Syncretism",
          "The blending of an incoming tradition with an existing one, the normal outcome when a religion travels with merchants rather than armies."
        ],
        [
          "Transmission route",
          "A documented path of contact, the evidence that turns a chronological coincidence into a diffusion claim."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Church of the East",
          "The Christian tradition with communities along the Asian trade routes, prominent under Mongol religious policy and now largely forgotten in survey accounts."
        ],
        [
          "Theravada Buddhism",
          "The branch carried from Sri Lanka to mainland Southeast Asia, where it became the legitimating religion of Burmese, Khmer and Thai kingdoms."
        ],
        [
          "Chan and Zen",
          "The Chinese Buddhist tradition and its Japanese form, transmitted by monks along the East Asian maritime routes."
        ],
        [
          "Sufi orders",
        ...
        [
          ...
          "The Franciscan appointed archbishop at the Yuan capital in 1307, evidence that Latin Christianity reached China along the same roads."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Papermaking",
          "The Chinese technique that reached Samarkand and Baghdad in the eighth century and Italian mills by the late thirteenth, cheapening books everywhere it arrived."
        ],
        [
          "Gunpowder",
          "Compounded in China and described in eleventh-century military manuals, present in European warfare from the fourteenth century."
        ],
        [
          "Magnetic compass",
          "Described in China in the eleventh century and used for navigation by the twelfth, lengthening the practical sailing season across the Indian Ocean."
        ],
        [
          "Movable type",
          "Invented in China in the eleventh century and cast in metal in Korea, and very probably invented separately in Europe around 1450."
        ],
        [
          "Stirrup",
          "A Central Asian and Chinese riding technology that diffused west; its supposed role in causing European feudalism is contested."
        ]
      ]
    },
    {
      ...
      "num": "04",
      "accent": "oxide",
      "name": "Cities Rise, Cities Decline",
      "navLabel": "Cities rise and decline",
      ...
      "parts": [
        {
          "heading": "Why trade could produce urban growth",
          "blocks": [
            {
        ...
        {
          "heading": "Why cities could also decline",
          "blocks": [
            {
            ...
            },
            {
              "note": {
                "kind": "misconception",
                "label": "Common mistake to avoid",
                "html": "Do not turn this into a list of famous cities. For each example, state the mechanism connecting trade or productivity to urban growth or decline."
              }
            }
          ]
        }
      ...
      "terms": [
        [
          "Urbanization",
          "Growth in the share or number of people living in towns and cities, often supported by productivity and commercial specialization."
        ],
        [
          "Commercial node",
          "A city whose location and services make it a repeated stopping, transfer or exchange point."
        ],
        [
          "Route shift",
          "A change in where exchange flows, which can enrich new nodes and weaken older ones."
        ],
        [
          "Urban decline",
          "Loss of population, commerce or political importance as the systems supporting a city weaken."
        ]
      ]
    },
    {
      ...
      "num": "05",
      "accent": "gold",
      "name": "Travelers Write the Connected World",
      "navLabel": "Travelers write the world",
      ...
      "parts": [
        {
          "heading": "Three travelers the CED names",
          "blocks": [
            {
        ...
        {
          "heading": "Use travel writing as evidence, not as unsourced fact",
          "blocks": [
            {
      ...
      "terms": [
        [
          "Ibn Battuta",
          "Moroccan Muslim jurist whose fourteenth-century travels and later account document wide Islamic and Afro-Eurasian connections."
        ],
        [
          "Marco Polo",
          "Venetian traveler whose account became an influential European description of Asian societies and the Yuan world."
        ],
        [
          "Margery Kempe",
          "English Christian pilgrim whose dictated account records long-distance religious travel in the early fifteenth century."
        ],
        [
          "Travel account",
          "A written or dictated record of travel whose value depends on both what it describes and the perspective of its author."
        ]
      ]
    }
  ],
  "closing": {
    ...
    "intro": "Build answers across all three developments: diffusion, urban change and travel writing. Each model below names a consequence, gives evidence and explains the network mechanism behind it.",
    "pairs": [
      {
        "category": "Technology",
