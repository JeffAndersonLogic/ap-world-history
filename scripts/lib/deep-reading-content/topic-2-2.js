...
/**
 * Canonical Deep Reading source for Topic 2-2.
  ...
  "empires": [
    {
      ...
      "terms": [
        [
          "Chinggis Khan",
          "The title taken by Temujin in 1206 when the united steppe tribes proclaimed him; the founder of the empire and of its organization."
        ],
        [
          "Decimal organization",
          "The army structured in tens, hundreds, thousands and tumens of ten thousand, with clans deliberately mixed and commanders appointed."
        ],
        [
          "Tumen",
          "A unit of ten thousand, the largest formation in the decimal system and the standard building block of a Mongol field army."
        ],
        [
          "Yassa",
          "The body of law attributed to Chinggis Khan, known only through quotation and summary in later writers, with no complete text surviving."
        ],
        [
          "Kurultai",
          "The assembly of Mongol nobles that proclaimed a khan, and whose need to gather from across Eurasia repeatedly interrupted campaigns."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Composite bow",
          "A short bow of wood, horn and sinew, powerful enough to be decisive and short enough to shoot from horseback at the gallop."
        ],
        [
          "Feigned retreat",
          "A withdrawal staged to look like a rout, drawing a pursuing enemy out of formation into a prepared encirclement."
        ],
        [
          "Nerge",
          "The great collective hunt that trained coordinated maneuver over long distances, the exercise behind Mongol battlefield discipline."
        ],
        [
          "Counterweight trebuchet",
          "The heavy siege engine, built by engineers from the Islamic world, that broke the long Song defense at Xiangyang in 1273."
        ],
        [
          "Otrar",
          "The Khwarezmian city whose governor had a Mongol trade caravan killed in 1218, the immediate cause of the westward invasion."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Yuan",
          "The Mongol dynasty ruling China from 1271 to 1368, whose khan held nominal seniority over the other khanates."
        ],
        [
          "Ilkhanate",
          "The Mongol state in Persia and Iraq, which converted to Islam under Ghazan in 1295 and became a patron of Persian scholarship."
        ],
        [
          "Golden Horde",
          "The Mongol khanate of the western steppe, dominating the Russian principalities and eventually Turkic and Muslim in culture."
        ],
        [
          "Chagatai Khanate",
          "The Mongol khanate of Central Asia, astride the overland trade routes and the most politically unstable of the four."
        ],
        [
          "Semu",
          "The Yuan category of non-Chinese, non-Mongol officials and specialists, ranked above Chinese subjects in the dynasty&rsquo;s social order."
        ],
        [
          "Yelu Chucai",
          "The administrator who argued that taxing conquered farmers would yield far more than converting their land to pasture, and won."
        ]
      ]
    },
    {
      ...
      "parts": [
        ...
        {
          "heading": "The three CED transfers to know explicitly",
          "blocks": [
            {
      ...
      "terms": [
        [
          "Marco Polo",
          "The Venetian whose account of the Yuan empire, dictated in the 1290s, became Europe&rsquo;s most widely read description of Asia."
        ],
        [
          "Rabban Bar Sauma",
          "The Church of the East monk born near the Mongol capital in China who traveled west as an Ilkhanid envoy and met the kings of France and England."
        ],
        [
          "Rashid al-Din",
          "The Ilkhanid vizier whose history of about 1307 covered the Mongols, the Islamic world, China, India and western Europe from their own sources."
        ],
        [
          "Blue-and-white porcelain",
          "Chinese ceramics painted with Persian cobalt in shapes designed for Middle Eastern buyers, the clearest single object of Mongol-era integration."
        ],
        [
          "Pax Mongolica",
          "The period of relative security along the Eurasian routes under Mongol rule, which moved goods, specialists, techniques and disease alike."
        ],
        [
          "Greco-Islamic medical knowledge",
          "Medical learning rooted in Greek traditions and developed in the Islamic world that circulated toward western Europe through intensified Eurasian contact."
        ],
        [
          "Numbering systems",
          "South Asian mathematical notation transmitted through the Islamic world and increasingly adopted in Europe."
        ],
        [
          "Uyghur script",
          "A writing system adopted by Mongol rulers for Mongolian administration, illustrating cultural borrowing by conquerors."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Qanat",
          "An underground irrigation channel requiring constant skilled maintenance, whose destruction in Iran and Iraq took farmland out of cultivation for generations."
        ],
        [
          "Kurultai",
          "The assembly that elected a khan, which made every succession a crisis and repeatedly interrupted campaigns."
        ],
        [
          "Toluid civil war",
          "The open conflict between branches of the ruling family from 1260, after which the khanates functioned as separate states."
        ],
        [
          "Red Turban rebellion",
          "The mid-fourteenth-century risings in China, amid flood, famine and currency collapse, that ended Yuan rule in 1368."
        ],
        [
          "Timur",
          "The Central Asian conqueror who rebuilt an empire from the Chagatai wreckage late in the fourteenth century, ruling through Chinggisid legitimacy he did not inherit."
        ]
      ]
    }
  ],
