...
module.exports = {
  ...
  empires: [
    // ── 01 ────────────────────────────────────────────────────────────────────
    {
      ...
      num: '01',
      accent: 'gold',
      name: 'Ottoman Governance of Religious Communities',
      navLabel: 'Accommodation',
      dates: 'c. 1450 to 1800 &nbsp;·&nbsp; The Ottoman millet system',
      thesis: `Ottoman rule over non-Muslim subjects was not liberal toleration and was not persecution. It was a set of arrangements for taxing and governing a religiously plural empire cheaply, and understanding them as a mechanism rather than as a virtue is what lets you use them accurately. <span class="kt">Millet</span> is useful shorthand for those arrangements, with one warning attached that the first paragraph below makes.`,
      parts: [
        {
          heading: 'How it worked, and what the word actually covers',
          blocks: [
            { p: `Take the warning first, because the Topic 3.2 chapter already gives it and a student who contradicts himself between units loses both marks. The tidy empire-wide "millet system" of the textbooks, a fixed set of neatly bounded communities each run by one recognized chief under a standing charter, is largely a nineteenth-century formalization projected backward onto these centuries. Recent Ottoman scholarship has taken that model apart.` },
            { p: `What the sources show for c. 1450 to 1800 is more varied and more local. Ecclesiastical hierarchies, rabbinic authorities, guilds, neighborhoods and village communities each held pieces of the arrangement; privileges were negotiated city by city and renegotiated when a sultan or a patriarch changed; and non-Muslims used Ottoman courts alongside their own, frequently by choice, because a kadi's ruling was enforceable. Use "millet" as shorthand for governing religious difference through the community's own institutions, and do not project the later chart backward.` },
            { p: `The principle underneath the label is solid, and it is what an answer should name. Greek Orthodox, Armenian Apostolic and Jewish communities held the status of protected non-Muslim subjects in Islamic law, and the state left much of their internal life, family law, marriage, inheritance, schooling, internal disputes and charity, to their own religious authorities, who were held answerable for their community's obedience and for delivering its taxes.` },
            { p: `The mechanism to write is a combination rather than a single bargain, and the jizya is the piece most often described wrongly. Non-Muslim subjects paid the <span class="kt">jizya</span>, the tax that Islamic legal tradition had attached to protected non-Muslim status for centuries before any Ottoman collected it. It was not invented as a fee in exchange for communal self-rule, and writing it that way turns a legal status into a transaction it never was. Alongside it came real disabilities: testimony that carried less weight against a Muslim in an Islamic court, restrictions on dress, on building or repairing houses of worship and on riding certain animals, and exclusion from certain offices. Against that stood the protection of the state, the practice of their religion, and substantial room to run their own affairs in particular spheres, while they remained inside Ottoman courts, taxation, property law and provincial politics for everything else.` },
      ...
      useThis: {
        tool: `Tax and delegate. <em>The mechanism is that an empire too large and too plural to administer directly leaves family law, worship, schooling and internal discipline to the religious authorities a community already has, and holds those authorities answerable for obedience and for the tax, so the state buys order and revenue without building parallel institutions and diversity survives as a by-product of not paying to eliminate it.</em>`,
      ...
      terms: [
        ['Millet', 'Shorthand for Ottoman governance of a recognized religious community through its own authorities; the standardized empire-wide system is a later formalization read backward.'],
        ['Jizya', 'The tax on protected non-Muslim subjects, drawn from Islamic legal tradition long before the Ottomans rather than invented as a fee for communal self-rule.'],
      ...
      parts: [
        {
          ...
          blocks: [
            ...
            { p: `Alongside that they built a set of separations designed to preserve the Manchus as a distinct group. <b>Dual appointment</b> put a Manchu and a Han official in many senior posts. The <b>banner system</b> organized Manchus, along with Mongol and some Han bannermen, into hereditary military units with their own registers, stipends and garrisons, physically quartered in walled sections of major cities. Intermarriage between Manchus and Han was restricted, bannermen were barred from ordinary commerce and expected to live by their stipends and their military service, and Qing governments repeatedly restricted Han settlement in parts of Manchuria without ever preventing the migration. One thing the textbook version gets wrong is worth correcting here: bannermen were not shut out of the examinations. They sat the regular civil examinations, and the Qing added separate quotas and translation examinations in Manchu and Mongol on top, which produced a parallel route into the same elite rather than exclusion from it.` },
    ...
    // ── 03 ────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `The consequences were legal and specific, which is what the success criteria want. Higher administrative and ecclesiastical offices were restricted by category. Guilds limited membership. Universities and religious orders applied purity-of-descent requirements. Tribute obligations fell on Indios and on free people of African descent and not on Spaniards. Sumptuary rules restricted dress. The <em>Pragmática</em> of <span class="num">1776</span> required parental consent for the marriages of children under a set age and let families go to court against a match they judged socially unequal. It was not a ban on marriage across categories, and describing it as one gives away that you have not read it; what it did was hand relatives a legal instrument in which ancestry and calidad became arguments a court would hear. And the clearest single case is the <span class="kt">gracias al sacar</span>, a royal dispensation a person of mixed descent could petition for and pay a substantial fee to obtain, which lifted named legal disabilities of ancestry so that the holder could take an office, enter a guild, a university or a religious order otherwise closed. State it that way rather than as buying whiteness: what the crown sold was a set of specific exemptions, not a new entry in a box on a form.` },
            { note: {
              kind: 'howknow',
              label: 'How we know: the money proves the mechanism',
              html: `The <em>gracias al sacar</em> is the most useful single document in this topic because of what it concedes. If ancestry were an unchangeable natural fact with automatic consequences, a fee could not lift them. The crown sold the exemptions anyway, which means that in operation the system was a legal and social status rather than a biological one, and that it was for sale to the rich. Petitions survive in the colonial archives with the applicant&rsquo;s case, the fee, and the offices sought, so we can see individuals reasoning about their own position in the hierarchy. Use it to make an argument rather than as a curiosity: a category that money can change is a category doing economic work.`
            } }
          ]
        },
        {
      ...
      terms: [
        ...
        ['Gracias al sacar', 'The purchasable royal dispensation lifting named legal disabilities of mixed descent, proof that the category was legal rather than natural.'],
    ...
    pairs: [
      {
        ...
        body: `Ottoman government left Greek Orthodox, Armenian and Jewish communities substantial room to run family law, worship and schooling through their own authorities, held those authorities answerable for obedience and taxes, and collected the jizya, which bought order and revenue without building parallel institutions, though the tidy empire-wide millet system of the textbooks is a nineteenth-century formalization read backward; Bayezid II received Jews expelled from Spain in 1492 and Salonica became a majority-Jewish city. The Qing, about a million Manchus ruling over a hundred million Han, kept the Confucian examinations and staffed the bureaucracy with Han officials while fencing themselves off through the banner system, dual appointments, marriage restrictions and repeated limits on Han settlement in Manchuria. One majority accommodated minorities beneath it; one minority protected itself from the majority above which it sat.`
      },
      {
        category: 'Institutions',
        title: 'A category you can buy is a category doing economic work',
        body: `Casta status was assigned at baptism, recorded in parish registers and attached to specific consequences: restricted offices and ecclesiastical posts, guild and university exclusions on purity-of-descent grounds, tribute liability for Indios and free people of African descent, sumptuary rules, and the Pragmatica of 1776 letting families block unequal marriages. Yet the crown sold the gracias al sacar, a dispensation lifting named legal disabilities of mixed descent so the holder could take an office or enter a university. If ancestry were an unalterable natural fact a fee could not touch what followed from it, so the sale is proof that casta was a legal and social status rather than a biological one, and that relief from it was available to the rich.`
      },
      {
        category: 'Structure',
