  ...
  empires: [
    ...
    // ── 02 ────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `<b>Malacca</b>, and before it the Srivijayan ports on the Strait, controlled the only practical sea passage between the Indian Ocean and the South China Sea. Its function was toll collection at a chokepoint roughly nine hundred kilometers long and in places very narrow, plus the wait: ships coming from the west on one monsoon met ships coming from the east on the other, and the goods changed hands rather than the ships making the whole run.` },
      ...
      terms: [
        ...
        ['Srivijaya', 'The maritime power on Sumatra that taxed passage through the Strait of Malacca and funded a center of Buddhist learning with the proceeds.'],
    ...
    // ── 03 ────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `<b>Timbuktu</b> and <b>Gao</b> sat on or near the Niger Bend. Their function was the junction of two different transport systems: camel caravans from the north met river transport on the Niger, which reached deep into West Africa. That is why Timbuktu became a scholarly center as well as a commercial one. A place where merchants must stop, wait and transfer is a place where books, students and teachers accumulate.` },
      ...
      terms: [
        ...
        ['Timbuktu', 'A Niger Bend city where camel caravans met river transport, and which became a center of scholarship as a result.'],
    ...
    // ── 04 ────────────────────────────────────────────────────────────────────
    {
      ...
      terms: [
        ...
        ['Vector', 'The organizm that carries a pathogen between hosts; here the flea, and behind it the rat and the grain ship.'],
      ...
      parts: [
        {
          ...
          blocks: [
            ...
            { p: `The transfer was not accidental and that is the interesting part. Song officials identified the variety, obtained seed, and distributed it deliberately in the early eleventh century, with the state promoting the new rice in the lower Yangtze. This is a government running an agricultural extension program a thousand years ago, and it shows that "trade networks moved crops" sometimes means a state noticed something useful in a neighbor's fields and went to get it.` },
      ...
      parts: [
        {
          heading: 'What moved, and how',
          blocks: [
            { p: `Buddhism reached China along the Silk Roads in the first centuries CE, carried by monks who traveled with caravans and by merchants who funded monasteries at the places they stopped. The evidence is physical and it is everywhere on the route: the Mogao caves at Dunhuang, hundreds of decorated cave temples, were funded in large part by merchants, and Silk Road oasis towns became monastery towns and translation centers. Foundations 2 explains why the mechanism worked, which is that giving to the monastic community generated merit and that a monastery could be founded anywhere.` },
