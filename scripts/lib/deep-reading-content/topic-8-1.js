...
module.exports = {
  ...
  empires: [
    ...
    // ── 03 ────────────────────────────────────────────────────────────────────
    {
      ...
      thesis: `The postwar map of Europe was set less by what anyone had agreed than by where the armies were standing when the shooting stopped, and the one great power whose industrial base had never been fought over came out of the war with the industry, the currency and, for four years, the bomb.`,
      parts: [
        {
          heading: 'The American position',
          blocks: [
            { p: `Be exact about this, because the loose version is wrong: American territory was fought over, since Japanese forces occupied Attu and Kiska in the Aleutians, and the Philippines, then an American possession, was invaded, occupied and retaken at enormous cost. What escaped was the part that mattered economically. No fighting reached the American mainland, and American industrial output roughly doubled over the course of the war. By <span class="num">1945</span> the United States accounted for something close to half of world manufacturing output, a share that says as much about the destruction of everyone else's factories as about American growth, and which fell steadily as Europe and Japan rebuilt. It held roughly two thirds of the world's monetary gold and, until August <span class="num">1949</span>, a monopoly on nuclear weapons.` },
