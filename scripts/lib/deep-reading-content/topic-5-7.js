...
module.exports = {
  ...
  howTo: {
    ...
    intro: `Sections 01–03 explain the financial institutions and free-trade ideas that scale industrial capitalism. Keep economic imperialism as an important extension into Unit 6, but the formal Topic 5.7 story must also reach the consumer: improved manufacturing increased the availability, affordability and variety of goods and contributed to higher standards of living for some people.`,
    steps: [
  ...
  closing: {
    ...
    pairs: [
      {
        category: 'Transnational business',
        title: 'Finance turned local savings into global industrial capital',
        body: `Limited liability and stock markets reduced the personal risk of investment and pooled capital from many shareholders, while banks moved credit across regions. The <span class="kt">Hong Kong and Shanghai Banking Corporation (HSBC)</span>, founded in 1865, is a CED example because its purpose was explicitly transnational: finance commerce between Asian ports and British markets. The mechanism is not that banks merely "helped trade"; credit, exchange services and pooled capital let firms operate at a scale and distance that individual merchants could not finance alone.`
      },
      {
        category: 'Consumer capitalism',
        title: 'Industrial capitalism changed what ordinary households could buy',
        body: `Improved manufacturing methods increased output and lowered the unit cost of many textiles, tools and household goods, making manufactured <span class="kt">consumer goods</span> more available, more affordable and more varied. Over the nineteenth century, rising real incomes for some workers and expanding middle classes meant that material <span class="kt">standards of living</span> improved for part of the population. The claim must be qualified: early factory workers could face terrible wages and housing, and colonial producers did not share equally in industrial wealth. The CED point is therefore a real but uneven effect—industrial capitalism expanded consumption and raised living standards for some, not for everyone at the same time.`
      },
      {
        category: 'Mechanism',
