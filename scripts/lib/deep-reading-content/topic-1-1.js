      ...
      parts: [
        {
          ...
          blocks: [
            { p: `A candidate faced three stages. The prefectural examination, held in his home prefecture, qualified him to travel to the capital. The departmental examination at the capital, run by the Ministry of Rites, produced the short list. The <span class="kt">palace examination</span>, instituted by Emperor Taizu in <span class="num">973</span> after a favoritism scandal and vastly expanded under Taizong, ranked the successful candidates and was held in the emperor's name. That third stage is not a formality, and it is the part students most often leave out. Because the emperor personally conferred the final ranking, every new official owed his place to the throne rather than to the minister who had graded him, which cut off the patronage networks that turn a bureaucracy into a set of factions.` },
