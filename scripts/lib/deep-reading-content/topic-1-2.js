...
module.exports = {
  ...
  empires: [
      ...
      parts: [
        {
          ...
          blocks: [
            ...
            { p: `The decisive moment came in <span class="num">945</span>, when the Buyids, a dynasty from northern Iran, took Baghdad and simply kept the caliph in place. They ran the government, commanded the army and collected the revenue. He kept the title, the ceremony, the Friday sermon in his name, and no power at all.` }
          ]
        },
        {
    ...
    // ── 02 ────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `The mechanism is the point. A soldier bought as a child in a distant land has no clan in Egypt, no local marriage alliances, no village that expects favors, and no path to power except through the household that raised him. He is, by construction, loyal to the state rather than to a family, which is exactly what a ruler surrounded by ambitious relatives wants. In <span class="num">1250</span> the mamluk regiments in Egypt cut out the middleman and took the sultanate for themselves, and the Mamluk Sultanate ruled Egypt and Syria until <span class="num">1517</span>.` },
      ...
      terms: [
        ['Mamluk', 'A soldier bought as a boy, converted, trained and freed, whose lack of local kinship made him loyal to the state; from 1250 the ruling class of Egypt and Syria.'],
    ...
    // ── 03 ────────────────────────────────────────────────────────────────────
    {
      ...
      thesis: `Conquest moved borders in the seventh and eighth centuries. Almost all of the conversion happened later, slowly, through people whose job was not conquest at all, and the places Islam reached after 1200 were mostly places no Muslim army ever went.`,
      parts: [
        {
          heading: 'The mechanism that is not conquest',
          blocks: [
            { p: `Start with the fact that settles the question. In this period Islam became the majority religion of the Swahili coast of East Africa, of the trading cities of the West African Sahel, and of the ports of the Indonesian archipelago and the Malay peninsula. No Muslim army conquered any of those places. Whatever explains conversion there cannot be conquest, and whatever explains it there is likely to explain a good deal of it elsewhere too.` },
            { p: `The first channel is commerce. Muslim merchants dominated the Indian Ocean and trans-Saharan routes, and a local ruler or merchant who converted joined a network that ran from Morocco to China: shared law for contracts, shared language for correspondence, credit that would be honored in a port two thousand miles away, and marriage alliances into merchant families. Conversion was not a bribe. It was membership in the largest commercial system on earth, and it is why conversion so often happened first among the coastal and urban trading class and reached the interior much later or not at all.` },
