...
module.exports = {
  ...
  closing: {
    ...
    pairs: [
      {
        category: 'Social synthesis',
        title: 'Economic development changed social structure unevenly',
        body: `Plantation expansion, silver extraction, and widening markets changed more than trade. Plantation demand expanded Atlantic chattel slavery; colonial conquest and commerce helped produce new social categories and <span class="kt">elite</span> groups such as the Spanish American <span class="kt">casta</span> hierarchy; and the Atlantic slave trade altered demographic, gender, and family patterns in parts of Africa. At the same time, older peasant and artisan labor continued and intensified because expanding markets still depended on households and workshops. The social result was therefore uneven change rather than total replacement.`
      },
      {
        category: 'Thesis',
