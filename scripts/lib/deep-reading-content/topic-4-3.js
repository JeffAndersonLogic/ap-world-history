  ...
  empires: [
    // ── 01 ────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        {
          ...
          blocks: [
            { p: `Many of the great infectious killers of Afro-Eurasia crossed to humans from animals. Measles is closely related to a cattle disease, influenza circulates among birds, pigs and people, and others have animal reservoirs or close animal relatives. That kind of crossing needs sustained contact between large numbers of people and large numbers of animals, which is what farming villages with cattle, pigs, sheep, goats, horses and chickens provide.` },
            { p: `Do not push that further than it goes. Ancient DNA and pathogen genomics have complicated several of these histories over the last two decades, and smallpox and tuberculosis no longer trace to a herd animal in any simple way, so "cows gave us this one, pigs gave us that one" is a model to use with care. Animals are a large part of the ecological story rather than the single origin of every great killer.` },
            { p: `The second condition is population density. A disease that confers lifelong immunity on survivors burns out in a small community, because it runs out of people who can catch it. Only in a large, connected population can it become endemic, circulating permanently and infecting each new generation of children.` },
        ...
        },
        {
          ...
          blocks: [
            { p: `A <span class="kt">virgin soil epidemic</span> is an outbreak in a population with few people carrying prior immunity to a pathogen. Immunity to smallpox is acquired rather than inherited: a European adult was resistant because he had survived the disease as a child, not because of anything in his ancestry. Where almost nobody has had it, the pathogen reaches every age group at once instead of only children, which is the part that turns an epidemic into something else.` },
            { p: `That is the mechanism to write, and it is about proportions rather than absolutes: not everyone is infected and not everyone who is infected dies, but enough adults are sick at the same time that the society stops working. When every adult is sick simultaneously, nobody plants, nobody harvests, nobody hauls water, nobody nurses the sick, and nobody leads. People die of hunger, thirst and neglect who would have survived the infection itself. Then the next disease arrives, into a population already weakened and disorganized, and after it the next: smallpox, then measles, then influenza, then typhus, in waves across decades.` },
            ...
            { note: {
              ...
              html: `Never write that Indigenous Americans were biologically weaker or that Europeans were biologically stronger. Immunity to smallpox is acquired by surviving childhood infection, and the difference between the hemispheres is a fact about animal and population ecology and about thousands of years of separation, not about the worth or the constitution of the people. One qualification keeps this accurate rather than merely reassuring: populations can differ in inherited immune variants shaped by long exposure to particular diseases, which is exactly what section 05 describes for malaria in West and Central Africa. That is a different mechanism from surviving smallpox as a child, and neither one ranks anybody. Two checks confirm it: European populations were devastated in exactly the same way by a novel pathogen in the fourteenth century, which the Topic 2.6 chapter describes, and Europeans arriving in West Africa died in appalling numbers from malaria and yellow fever, diseases the local population had substantial resistance to. Novelty is the variable, and it cut in every direction.`
            } }
          ]
        }
      ],
      useThis: {
        ...
        comparison: `Against the <em>Black Death</em> in Topic 2.6: the same mechanism, a novel pathogen reaching an unexposed population along new trade routes, at a mortality Europe survived and rebuilt from within a century. The difference in outcome is not the biology, and it is not that Europe suffered a single wave, because plague returned to Europe repeatedly for three centuries after 1347. It is that Europe met a recurring epidemic while its own states, fields and families stayed in place, and the Americas met several unfamiliar pathogens arriving together with conquest, forced labor, relocation and the wrecking of the food system.`
      },
      terms: [
    ...
    pairs: [
      {
        ...
        body: `Many Afro-Eurasian crowd diseases have animal reservoirs or close animal relatives, and they became endemic in dense, connected populations, so European adults carried immunity acquired by surviving them in childhood. The Americas had domesticated the llama, alpaca, guinea pig, turkey and dog, none living in the crowded proximity that generates such diseases, and had been separated from Afro-Eurasia for thousands of years. The difference lies in the animal and population ecology and in the isolation rather than in the people, which is confirmed twice over: Europe suffered exactly this kind of collapse from a novel pathogen in the fourteenth century, and Europeans died in appalling numbers of malaria and yellow fever in West Africa. Novelty was the variable, and it cut in every direction.`
      },
      {
