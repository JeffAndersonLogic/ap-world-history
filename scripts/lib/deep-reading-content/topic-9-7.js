...
module.exports = {
  ...
  empires: [
    ...
    // ── 04 ────────────────────────────────────────────────────────────────────
    {
      ...
      useThis: {
        tool: `Judging a movement by a documented change in the target. <em>The mechanism is that protest coincides with many other pressures, so the strongest evidence that a campaign caused an outcome is a record made by the target itself: a commissioned review that criticizes its own project, a withdrawal, a new complaints procedure, a dropped lawsuit, a signed binding agreement. Applying that standard produces a shorter and far more defensible list than a narrative in which every reform followed a march.</em>`,
