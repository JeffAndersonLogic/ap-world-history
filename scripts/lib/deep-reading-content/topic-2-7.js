...
/**
 * Canonical Deep Reading source for Topic 2-7.
...
module.exports = {
  ...
  "deck": "Sand, water and grass created different transportation problems, but the networks also shared an economic logic: demand made exchange worthwhile, commercial institutions reduced friction, productive capacity responded to wider markets, and states and cities captured value from the resulting flows.",
  "meta": [
    "Five sections",
    "No new content, one new skill",
  ...
  "empires": [
    {
      ...
      "terms": [
        [
          "Network",
          "A system of routes, actors and institutions moving goods between regions, of which this unit examines three interlocking examples."
        ],
        [
          "Constraint",
          "The binding limit each environment imposes, security overland, timing at sea, water in the desert, which shapes every institution built around it."
        ],
        [
          "Actors",
          "The merchants, carriers, guides, financiers and officials who make a network work, and whose identity differs sharply between the three."
        ],
        [
          "Endpoint",
          "Where a route terminates and its cargo transfers to another system, which is why the three networks were connected rather than parallel."
        ],
        [
          "Interlocking",
          "The condition of the three networks: shared merchants, shared markets and shared endpoints rather than separate economies."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Relay trade",
          "The pattern in which each merchant works one familiar segment and sells on, found on all three networks for the same reason."
        ],
        [
          "Partnership contract",
          "The arrangement separating capital from carriage, known as qirad, mudaraba or commenda in different legal traditions."
        ],
        [
          "Diaspora enforcement",
          "The use of kinship and shared religion to make agreements binding where no shared court existed."
        ],
        [
          "Unintended cargo",
          "Religions, techniques, crops, languages and diseases carried by contact rather than freight, on every network."
        ],
        [
          "Cairo Geniza",
          "The Cairo synagogue storeroom whose discarded documents record Jewish merchants using the same commercial instruments as their Muslim and Italian counterparts."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          "Cost per ton-mile",
          "The price of moving a given weight a given distance, the number that determines what a route can profitably carry."
        ],
        [
          "Fixed cost",
          "An expense incurred by making the journey at all, regardless of cargo, which is why the size of the transport unit matters so much."
        ],
        [
          "Capital intensity",
          "The amount of investment a form of trade requires, high for ships and low for a few camels, which shapes who can participate."
        ],
        [
          "Seasonality",
          "The wind-imposed schedule of Indian Ocean sailing, which forced residence in foreign ports and produced the merchant diasporas."
        ],
        [
          "Periodization",
          "Attention to when a comparison holds, since the overland routes of 1300 and of 1420 are not the same object."
        ]
      ]
    },
    {
      ...
      "parts": [
        {
          "heading": "Demand and productive capacity",
          "blocks": [
            {
      ...
      "terms": [
        [
          "Transshipment point",
          "A place where cargo must change transport mode, which forces a stop and lets a small state capture value from traffic it does not produce."
        ],
        [
          "Entrepot",
          "A port living on goods landed, stored and re-exported rather than produced or consumed locally."
        ],
        [
          "Hinterland",
          "The productive interior behind a port, whose absence is what made cities like Melaka wholly dependent on transit trade."
        ],
        [
          "Conversion pattern",
          "The recurring shape of religious change along commercial routes: ports and courts first, interiors late or never."
        ],
        [
          "Plantation model",
          "The combination of monoculture, processing plant, merchant capital and coerced labor developed around Mediterranean sugar and later carried to the Atlantic."
        ],
        [
          "Demand",
          "Consumer willingness to acquire goods from distant regions, creating an economic incentive for interregional exchange."
        ],
        [
          "Productive capacity",
          "The ability to produce goods; wider markets can encourage producers to expand output for export."
        ]
      ]
    },
    {
      ...
      "terms": [
        [
          ...
          "Two accounts placed side by side with no shared question, the most common failed comparison."
        ],
        [
          "Grain",
          "The level of detail in evidence; a mechanism on one side and a generality on the other is a structural weakness a reader will notice."
        ],
        [
          "Causal explanation",
          "The statement of what prior condition produced a difference and how, which is the component the success criteria require."
        ],
        [
          "Change over time",
          "A difference between two moments rather than two places, frequently mistaken for a comparison in this unit."
        ],
        [
          "Broader pattern",
          "The connection to Afro-Eurasian exchange as a whole, which the third success criterion asks the argument to reach."
        ]
      ]
    }
  ],
