...
module.exports = {
  ...
  closing: {
    ...
    pairs: [
      {
        category: 'Causation',
        title: 'Cheap copying is the enabling cause and human networks are the carrying cause',
        body: `A song or a film costs almost the same to make whether one person receives it or a hundred million do, so once broadcasting and then digital distribution made sending nearly free, the economics of culture changed completely. That is the enabling cause and it carries nothing by itself. Reggae reached the world through named carriers: cheap vinyl and radio play, Caribbean migration to Britain and North America from the 1950s that built audiences before the records arrived, an Island Records contract with international distribution in the early 1970s, and constant touring. Bob Marley played Zimbabwe's independence ceremony in April 1980 and died in May 1981, by which time anti-apartheid activists and Indigenous rights movements were using songs written about Jamaican conditions. Name both causes and the answer is complete; name only the technology and it is a restatement.`
      },
      {
        category: 'Evidence',
