...
module.exports = {
  ...
  empires: [
    // ── 01 ────────────────────────────────────────────────────────────────────
    {
      ...
      thesis: `European rulers had land and no money. Every distinctive feature of the society follows from that one shortage: if you cannot pay a soldier, you must give him an estate, and a soldier with an estate is no longer entirely yours.`,
      parts: [
        {
      ...
      terms: [
        ...
        ['Manorialism', 'The economic system of the self-sufficient estate, in which peasants worked the lord&rsquo;s land as well as their own and owed dues in exchange for protection.'],
        ['Serf', 'A peasant bound to the land with hereditary customary rights in it, who could not be sold away from it and kept what he produced beyond his obligations.'],
    ...
    // ── 02 ────────────────────────────────────────────────────────────────────
    {
      ...
      thesis: `The Latin Church taxed every household in Europe, ran its own courts under its own law, held perhaps a quarter of the land, monopolized literacy, and could order a king's subjects to stop obeying him. Any comparison of European state power that leaves it out is measuring the wrong institution.`,
      parts: [
        {
          ...
          blocks: [
            ...
            { p: `It also supplied the personnel. Nearly everyone in western Europe who could read and write in this period was a churchman, which is why royal chancelleries were staffed by clerics and why the word for a clergyman and the word for an office worker have the same root. A king who wanted to run an administration hired the Church's graduates, because there were no others.` },
            { p: `Universities are the institutional legacy. Bologna, Paris, Oxford and their successors grew out of cathedral schools as self-governing corporations of masters and students, with a curriculum of law, medicine, theology and Aristotelian philosophy, much of it reaching Europe through Latin translations from Arabic. That is the direct link between this topic and Topic 1.2, and it is worth making explicitly: the reason a European university had Aristotle to argue about is that Muslim and Jewish scholars in Spain and Sicily had preserved, extended and translated him.` }
          ]
        },
        {
          heading: 'The weapon a king could not answer',
          blocks: [
            { p: `The Church's decisive instrument was spiritual sanction. <span class="kt">Excommunication</span> cut a person off from the sacraments; interdict suspended them across an entire kingdom, closing churches, halting marriages and denying burial in consecrated ground to everyone. Applied to a monarch, it released his subjects from their oaths of loyalty, which in a society built on oaths was a direct invitation to rebellion.` },
      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `Landlords responded exactly as you would expect. In England the <span class="kt">Statute of Labourers</span> of <span class="num">1351</span> attempted to fix wages at their pre-plague levels and to compel able-bodied workers to accept employment on the old terms. It failed, because a law cannot repeal a shortage, and the attempt to enforce it, combined with a new tax, produced the great English rising of <span class="num">1381</span>, in which rebels from Kent and Essex entered London, executed royal officials, and demanded the abolition of serfdom outright. It was suppressed, its leaders killed, and its central demand nonetheless arrived: serfdom in western Europe faded across the following century, dissolved by market forces rather than granted by anyone. In France the rising called the Jacquerie of <span class="num">1358</span>, during the ruinous middle stage of the Hundred Years War, was crushed with great brutality.` },
            { note: {
              kind: 'misconception',
              label: 'Common mistake to avoid',
