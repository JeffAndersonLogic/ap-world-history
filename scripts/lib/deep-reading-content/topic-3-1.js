...
module.exports = {
  ...
  empires: [
    ...
    // ── 05 ────────────────────────────────────────────────────────────────────
    {
      ...
      thesis: `The Qing and the Russians added more territory in this period than the Ottomans, Safavids and Mughals combined, and they are the two empires students are least likely to mention. Both absorbed the steppe into a settled bureaucratic empire, which earlier steppe conquerors from the Xiongnu to the Mongols had never done from the other direction, and gunpowder is a large part of the reason.`,
      parts: [
        {
          heading: 'The Qing',
          blocks: [
            { p: `The Ming dynasty fell in <span class="num">1644</span> amid rebellion, famine and fiscal crisis, and the <span class="kt">Manchus</span>, a people from the northeast who had built a state on the Ming frontier, took Beijing. Hong Taiji had already proclaimed the Qing in <span class="num">1636</span>; <span class="num">1644</span> is when Qing rule over China proper begins. They were a small conquest elite ruling an enormous Chinese population, and their solution combined two systems: the <span class="kt">banner</span> organization, a hereditary military and social structure covering Manchus, Mongols and allied Chinese, and the retention of the entire Chinese bureaucratic apparatus, including the examinations, with senior posts frequently doubled between a Manchu and a Chinese official.` },
            { p: `Then they expanded. Under Kangxi and Qianlong, the Qing took Taiwan, established control over Mongolia, brought Tibet under a protectorate, and in a series of campaigns in the eighteenth century destroyed the Zunghar Mongol state and annexed the vast territory that became Xinjiang. That last campaign was catastrophic for the Zunghars, whose population was largely destroyed by war, flight and epidemic, and it transformed a steppe frontier that had shaped Chinese security for two thousand years.` },
      ...
      terms: [
        ['Manchu', 'The northeastern people who proclaimed the Qing in 1636 and entered Beijing in 1644, a small conquest elite ruling an enormous Chinese population.'],
      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `<b>The sea.</b> These are land empires, and the qualifier is load-bearing. While the Ottomans, Safavids, Mughals and Qing expanded across land, European states were building the maritime empires of Unit 4. The Mughals never made blue-water naval power a priority to match their land armies, relying on coastal authorities, fortifications and arrangements with merchant shipping instead. That is not the same as ignoring Europeans: Mughal forces took Portuguese Hooghly in <span class="num">1632</span>, and Aurangzeb's government fought the English East India Company in the <span class="num">1680</span>s. The companies operated through permissions, alliances, coercion and periodic war, not through an empire that failed to notice them. Unit 4 begins in the space that observation opens.` }
          ]
        }
      ],
      useThis: {
  ...
  closing: {
    ...
    pairs: [
      ...
      },
      {
        ...
        body: `In 1591 a Moroccan force of a few thousand with firearms crossed the Sahara and destroyed a Songhai army many times its size, then found it could not govern what it had taken, and its garrison drifted into becoming a local power. Twice the Ottoman army, the most formidable in Europe, failed at Vienna, and not in the same way. In 1529 the city sat at the far end of a marching season, the weather was against the campaign and the heavy siege guns never arrived. In 1683 logistics strained again, and what decided it was the arrival of a Polish and Habsburg relief army that beat the besiegers in the field. Together they show that firepower decides battles and neither distance nor administration cares about firepower, which is the sentence to reach for whenever a prompt asks why an empire stopped expanding.`
      }
    ]
  }
};
