  ...
  empires: [
    // ── 01 ────────────────────────────────────────────────────────────────────
    {
      ...
      parts: [
        {
          ...
          blocks: [
            ...
            { p: `Maya intellectual achievements are usually listed and rarely explained. They developed the only complete writing system in the pre-Columbian Americas, capable of recording any sentence in the spoken language rather than only numbers and names. They used a positional number system with a symbol for zero, independently of India. Their astronomers tracked the movements of Venus and predicted eclipses, and their calendar system counted days continuously from a fixed starting point far in the past, which is how a modern scholar can date a Maya monument to a particular day.` },
            { p: `Why does a city-state need that much astronomy? Because kingship was legitimated by the ability to schedule: to say when to plant, when to hold a ceremony, when a cycle would close. A king who could predict the sky was a king who could be believed about everything else, which makes Maya astronomy a political instrument as much as a scientific one.` }
          ]
        },
        {
      ...
      terms: [
        ...
        ['Maya glyphs', 'The only complete writing system developed in the pre-Columbian Americas, able to record any spoken sentence rather than only numbers and names.'],
      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `The way to handle this in an essay is to explain its function rather than to condemn or excuse it. Public sacrifice of captives from other cities did three things at once: it made the state's cosmological claim visible, it terrorized the delegations from subject cities who were required to attend, and it turned military success directly into religious legitimacy, because only a warrior state can supply the sun. Notice, too, that a state which needs captives has a permanent reason not to finish off its enemies. Tlaxcala was never conquered, sat in the middle of Mexica territory, and became the decisive Spanish ally.` },
    ...
    // ── 03 ────────────────────────────────────────────────────────────────────
    {
      ...
      thesis: `The Inca ran perhaps ten million people across two and a half thousand miles of the world's most vertical terrain with no writing, no money, no markets to speak of and no wheeled transport, and did it by taxing work instead of goods.`,
      parts: [
        {
      ...
      useThis: {
        ...
        limit: `The mitma resettlements, the removal of chosen women from their communities, and a nobility that monopolized office are the exclusion evidence, and split inheritance forced each new ruler to conquer or be poor.`,
