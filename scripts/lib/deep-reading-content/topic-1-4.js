      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `The way to handle this in an essay is to explain its function rather than to condemn or excuse it. Public sacrifice of captives from other cities did three things at once: it made the state's cosmological claim visible, it terrorized the delegations from subject cities who were required to attend, and it turned military success directly into religious legitimacy, because only a warrior state can supply the sun. Notice, too, that a state which needs captives has a standing reason not to finish off its enemies. Tlaxcala was never conquered, sat surrounded by Mexica territory, and became the decisive Spanish ally.` },
