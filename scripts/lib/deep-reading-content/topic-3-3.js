      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `The settlement came in stages. The Peace of Augsburg in <span class="num">1555</span> ended a phase of war in the empire with the principle that each prince determined the religion of his territory, which is a remarkable formula: it treated religion as an attribute of a state rather than of a person, and it left subjects to conform or emigrate. The Thirty Years' War from <span class="num">1618</span> to <span class="num">1648</span> then devastated central Europe, with some regions losing a substantial fraction of their population, before the Peace of Westphalia ended it, added Calvinism to the confessions the settlement recognized, and built in protections for minorities that constrained rulers rather than simply handing each of them a free hand. It confirmed that no universal religious authority would govern Europe again, and it is not the birth certificate of unlimited sovereignty it is often made into.` },
            { note: {
              kind: 'misconception',
