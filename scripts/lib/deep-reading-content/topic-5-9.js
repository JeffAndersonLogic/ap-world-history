      ...
      parts: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `<b>Insecurity is the defining feature</b>, more than the level of the wage. Work was seasonal, trade was cyclical, and a downturn such as those of the <span class="num">1840</span>s put whole towns out of work at once. An injury ended earnings immediately, and the machine that caused it carried no liability. There was no sick pay and no pension, and after <span class="num">1834</span> public relief was meant to run through the workhouse of Topic 5.6, deliberately made worse than the worst job. In practice most paupers went on being relieved in their own homes, because refusing outdoor relief to everyone would have cost more than the parishes could raise in a bad year, so what the New Poor Law reliably delivered was not the workhouse itself but the threat of it. So a household that was comfortable in a good year was destitute within weeks of a bad one, and this is why so much working-class organizing, described in Topic 5.8, went into friendly societies, burial clubs and mutual insurance rather than into politics.` },
