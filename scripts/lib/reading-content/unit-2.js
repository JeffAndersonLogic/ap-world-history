...
module.exports = {
  ...
  '2.2': topic({
    ...
    deck: 'The Mongols are remembered as conquerors. For Topic 2.2, the bigger story is what their conquests did to Eurasia: they built new states, connected distant regions more tightly, moved knowledge across cultural boundaries, and eventually fragmented into regional khanates.',
    ...
    supportCards: {
      beforeYouRead: '<strong>Conquest → Empire → Pax Mongolica → Connectivity → Exchange.</strong> Everything in this reading fits somewhere in that chain.',
      readingTarget: 'How did an empire built through conquest make Eurasia more connected?'
    },
    vocabulary: ['Chinggis Khan', 'Mounted Archers', 'Siege Warfare', 'Khanates', 'Yuan Dynasty', 'Ilkhanate', 'Golden Horde', 'Chagatai Khanate', 'Yam', 'Pax Mongolica', 'Greco-Islamic Medical Knowledge', 'Numbering Systems', 'Uyghur Script'],
    sections: [
      section('1', 'The Setup', 'A Steppe Leader Builds a Conquest Machine', [
        'Around 1200, the Mongols were not one giant empire. They were groups of nomadic peoples living across the Eurasian steppe, where riding, herding, and warfare on horseback were part of everyday life. Then a leader named Temujin united many competing Mongol groups. You will know him by the title he took: <span class="kt">Chinggis Khan</span>.',
        'Chinggis Khan did more than gather warriors. He reorganized loyalty and command so Mongol armies could act as a coordinated system. Their famous <span class="kt">mounted archers</span> could move quickly, strike from a distance, gather intelligence, and use tactics such as feigned retreat to pull enemies out of position. Mobility mattered because it let Mongol commanders choose when and where to fight.',
        'But horses and bows could not solve every problem. When Mongol armies encountered fortified cities, they borrowed the expertise of engineers and specialists from peoples they conquered. They learned and adapted <span class="kt">siege warfare</span> rather than insisting that every battle be fought the Mongol way. That pattern matters: <strong>conquer → learn → adapt → conquer again.</strong>'
      ], 'AP Thinking, Causation', '<strong>Explain the mechanism, not just the weapon.</strong> Organization, mobility, and adaptation worked together to make Mongol conquest possible.'),
      section('2', 'From Conquest to Government', 'Taking Territory Was Only the First Problem', [
        'As Mongol armies expanded across China, Central Asia, Persia, Russia, and Eastern Europe, conquest created a new challenge: how do you govern millions of people spread across thousands of miles who speak different languages, follow different religions, and already have their own political traditions?',
        'The Mongols often answered that problem pragmatically. They used local administrators when useful, tolerated multiple religious communities, and borrowed practices that made government work. One of their most important tools was the <span class="kt">Yam</span>, a relay network of stations where official messengers could obtain fresh horses, food, and shelter. The Yam allowed orders and information to move across the empire much faster than a single rider could manage alone.',
        'The same willingness to borrow appears in writing. The Mongols adopted the <span class="kt">Uyghur script</span> to write Mongolian and help administer the empire. That is an important clue about Mongol rule: the conquerors were also borrowers. They did not simply spread Mongol practices outward; useful ideas could move <em>into</em> the Mongol state as well.'
      ], 'AP Thinking, State Building', '<strong>Separate conquest from rule.</strong> Conquest explains how the Mongols gained territory; administration, communication, and borrowing help explain how they tried to govern it.'),
      section('3', 'The Big Pivot', 'The Mongols Did Not Create the Silk Roads — They Changed the Conditions on Them', [
        'Remember Topic 2.1: the <strong>Silk Roads already existed</strong>. Merchants had been moving goods across Eurasia for centuries before the Mongols appeared. The historical change was that enormous stretches of those older routes now fell under related Mongol governments.',
        'Mongol rulers protected favored merchants and envoys, supported communication through the Yam, and reduced some of the political barriers that travelers had faced when moving between many competing states. Historians often call this period of increased security and movement the <span class="kt">Pax Mongolica</span>, or “Mongol Peace.” It did not mean that Mongol rule was peaceful everywhere. It means that after conquest, relative political stability across large territories could make long-distance movement more predictable.',
        'That changed what existing trade networks could do. Merchants moved. Diplomats moved. Missionaries moved. Skilled workers and specialists moved. Information moved. The Mongol Empire had been created by conquest, but its enormous geographic reach also became a <strong>bridge across Eurasia</strong>.'
      ], 'AP Thinking, Continuity & Change', '<strong>Name both sides of the change.</strong> The routes continued from earlier periods; Mongol rule changed the political conditions, protection, communication, and scale of movement across them.'),
      section('4', 'What Connectivity Actually Did', 'Goods Moved — but So Did Knowledge', [
        'This is where Topic 2.2 becomes more than a story about armies. When people from distant societies interact more often, knowledge can cross cultural and political boundaries.',
        'The College Board highlights several specific examples. <span class="kt">Greco-Islamic medical knowledge</span> circulated toward western Europe through wider Eurasian contacts. <span class="kt">Numbering systems</span> and mathematical knowledge also moved into Europe through intensified interregional exchange. And the Mongols themselves adopted the <span class="kt">Uyghur script</span>, showing that cultural transfer was not simply East-to-West or Mongol-to-everyone-else. Exchange moved in multiple directions.',
        'Notice the mechanism behind all three examples: <strong>contact → borrowing → adaptation → wider reach.</strong> The Mongols did not invent these ideas. Their significance is that the empire brought regions and peoples into repeated contact, making it easier for useful knowledge and practices to travel farther.'
      ], 'AP Thinking, Significance', '<strong>Use a specific transfer to prove the larger pattern.</strong> Increased connectivity mattered because it helped knowledge and practices cross political and cultural boundaries.'),
      section('5', 'The Empire Fragments', 'Political Unity Weakens, but the Connections Do Not Instantly Disappear', [
        'The Mongol Empire became extremely difficult to govern as one political unit. Succession disputes, enormous distances, and growing regional interests weakened centralized control. Over time, Mongol rule divided into major <span class="kt">khanates</span>: the <span class="kt">Yuan Dynasty</span> in China, the <span class="kt">Ilkhanate</span> in Persia, the <span class="kt">Golden Horde</span> in Russia and Eastern Europe, and the <span class="kt">Chagatai Khanate</span> in Central Asia.',
        'That fragmentation is important because it reminds us that political decline and network decline are not the same thing. The unified empire weakened, but the routes, contacts, and habits of exchange that had intensified under Mongol rule did not simply vanish the moment the empire divided.',
        'So the Mongol story contains a historical contradiction worth remembering: <strong>the same empire famous for destruction also created conditions that increased connection.</strong> The Mongols conquered enormous territories, built new states, fragmented into regional khanates, and at the same time helped goods, people, information, and knowledge move across Eurasia.'
      ], 'AP Thinking, Continuity & Change', '<strong>Do not confuse fragmentation with total collapse.</strong> Unified political control declined while many of the connections strengthened during Mongol rule continued.')
    ],
    takeaway: 'Conquest → Connection → Exchange. Chinggis Khan and the Mongols built a vast empire through organization and adaptation. Mongol rule and the Yam helped create the conditions associated with the Pax Mongolica, which facilitated trade and communication. Those connections encouraged cultural and technological transfer, even as the empire eventually fragmented into regional khanates.',
    questions: [
      { num: '01', skill: 'Continuity & Change', text: 'How did the Mongols build such a huge empire, and why did it eventually break into separate khanates?', placeholder: 'The Mongols built power by... It later fragmented because...' },
      { num: '02', skill: 'Causation', text: 'How did Mongol rule make it easier for people, goods, and information to move across Eurasia?', placeholder: 'Mongol rule increased movement by...' },
      { num: '03', skill: 'Significance', text: 'Choose one example—Greco-Islamic medicine, numbering systems, or the Uyghur script. What does it show us about the larger impact of Mongol connectivity?', placeholder: 'The example of ___ shows that Mongol connectivity...' }
    ]
  }),
