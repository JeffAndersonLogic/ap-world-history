...
md+='## Next audit pass\n\n';
md+='1. Deep CED/instructional audits are complete for Units 1 and 3–9; Unit 2 remains the certified reference implementation. Human findings supersede automated CLEAN labels.\n';
md+='2. Begin repair with the highest-risk topic-role mismatches, especially Units 4 and 5, while repairing Unit 3 before it is taught.\n';
md+='3. After each unit is repaired and human-reviewed, convert its verified spine into locked CED/coherence contracts so future changes are caught automatically.\n';
