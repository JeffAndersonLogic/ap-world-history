...
md+='## Next audit pass\n\n';
md+='1. Unit 3 deep audit is complete in docs/UNIT-3-DEEP-AUDIT.md; its human/CED findings supersede automated CLEAN labels for those topics.\n';
md+='2. Deep-audit Unit 4 next, then continue Units 5–9 in teaching order while pulling any structural REVIEW topic forward.\n';
md+='3. Convert each verified unit spine into locked CED/coherence contracts so future changes are caught automatically.\n';
