/* Topic 2.3 canonical authored teaching content: Indian Ocean exchange.
 * Pictures are assigned by slide id in topic-2-3-presentation-assets.js, so the
...
window.BEHISTORICAL_TEACHING = {
  meta: {
    ...
    subtitle: 'The ocean ran on a schedule. Predictable winds let ships, ports, and trust turn it into one system.',
    spine: 'The ocean ran on a schedule.',
    ...
    endTarget: 'Students can explain how monsoon knowledge and maritime technology enabled Indian Ocean exchange, identify major goods and merchant communities, and connect that growth to port states, diasporic communities, and state-sponsored voyages such as Zheng He\'s.'
  },
  priorities: {
    must: [
  ...
  flow: [
    ...
    {id:'open',label:'Hook + System',range:'4-8',slide:2},
    {id:'map',label:'Map the Basin',range:'8-13',slide:3},
    {id:'first10',label:'First & 10',range:'13-23',slide:5},
    {id:'winds',label:'Monsoon System',range:'23-33',slide:6},
    {id:'tech',label:'Ships + Navigation',range:'33-43',slide:8},
    {id:'check1',label:'Checkpoint 1',range:'43-49',slide:10},
    {id:'goods',label:'Goods + Merchants',range:'49-59',slide:11},
    {id:'ports',label:'Ports + Diasporas',range:'59-70',slide:13},
    {id:'room',label:'BeInTheRoom: Kilwa',range:'70-79',slide:16},
    {id:'skill',label:'AP Contextualization',range:'79-86',slide:17},
    {id:'check2',label:'Final Checkpoint',range:'86-89',slide:19},
    {id:'close',label:'Close + Bridge',range:'89-90',slide:20}
  ],
  quickLaunch: [
    {label:'Student Lesson 2.3',url:'../unit-2/lesson-2-3-indian-ocean.html?v=20260922-review-v1'},
    {label:'Student Presentation 2.3',url:'../unit-2/presentation-topic-2-3-student.html'},
    {label:'First & 10',url:'../unit-2/first-and-10-topic-2-3-indian-ocean-capture.html?v=schedule-v1'},
  ...
  slides: [
    {
      id:'preflight',phase:'preflight',kind:'action',eyebrow:'Teacher Preflight · Not Projected',title:'Teach the schedule, not the cargo list.',subtitle:'The spine is one sentence: the ocean ran on a schedule. Every beat today explains why that schedule made trade grow, and what the growth changed.',big:'2.3',
      notes:{minutes:2,land:['The learning objective asks for causes and effects of the growth of exchange networks after 1200. Causes here: monsoon knowledge, the compass, the astrolabe, and larger ship designs. Effects: growth of states (Swahili Coast city-states, Gujarat, Malacca), diasporic merchant communities, and state-backed contact under Zheng He.','The trap is a products lesson. Spices, textiles, gold, and porcelain are why merchants wanted to go; they are not the cause of the network growing.','Retelling slide: the causal chain near the end (Because, With, Therefore, As a result). If students can rebuild that slide from memory, they can answer Checkpoint 2.','Most slide pictures are AI-generated illustrations and are labeled that way. Use them to set a scene, not as evidence. The Evidence Lab carries the real objects: the Borobudur ship relief and Song celadon found at Kilwa.'],story:'The Indian Ocean was already a sailing world before 1200. What changed is that predictable monsoon timing, better navigation, and larger ships let more goods move farther on a reliable calendar, and that reliability built ports, merchant communities, and eventually Ming voyages on top of it.',ask:'Before class: can you say the whole topic in the causal chain in under thirty seconds?',listenFor:'Because the monsoon made timing predictable, and tools and ships expanded capability, trade grew in volume and range; as a result, port states and diasporic communities grew.',ap:'Causation, framed by contextualization: older routes first, then what intensified after 1200.'}
    },
    {
      id:'beready',phase:'beready',kind:'process',eyebrow:'BeReady · 4 Minutes · No Notes',title:'Pull yesterday’s network story back from memory.',subtitle:'Short answers are enough. Retrieve first; we will build from them.',
      steps:[
    ...
    {
      id:'hook',phase:'open',kind:'hero',eyebrow:'AP World History · Topic 2.3',title:'The Ocean That Ran on a Schedule',subtitle:'The Indian Ocean became a system when people learned to pair wind, ships, ports, and trust.',
    ...
    {
      id:'basin',phase:'map',kind:'map',eyebrow:'Geographic Grounding',title:'One ocean. Many connected regions.',subtitle:'East Africa · Arabia · India · Southeast Asia · China',
    ...
    {
      id:'four-pieces',phase:'map',kind:'process',eyebrow:'The Network',title:'A maritime system needs four pieces.',subtitle:'Wind · Ships · Ports · Trust',
    ...
    {
      id:'first10',phase:'first10',kind:'action',eyebrow:'First & 10 · 10 Minutes',title:'Read for the system.',subtitle:'What makes this network predictable, profitable, and connected?',big:'10',
    ...
    {
      id:'monsoon-calendar',phase:'winds',kind:'process',eyebrow:'Environmental Knowledge',title:'The monsoon is a round-trip calendar.',subtitle:'Sail with the seasonal reversal, not against it.',
    ...
    {
      id:'monsoon-map',phase:'winds',kind:'map',eyebrow:'Read the Wind',title:'The route changes with the season.',subtitle:'Movement follows a cycle, not a straight line.',
      layout:'image-forward',footer:'Timing is part of geography.',
    ...
    {
      id:'ships',phase:'tech',kind:'process',eyebrow:'Maritime Technology',title:'Ships turn wind into carrying power.',subtitle:'Better ships and navigational knowledge increased distance, reliability, and cargo volume.',
    ...
    {
      id:'navigation',phase:'tech',kind:'split',eyebrow:'Navigation',title:'Open water needs more than courage.',subtitle:'Compass · Astrolabe · Stars · Currents · Coastline knowledge',
    ...
    {
      id:'check1',phase:'check1',kind:'action',eyebrow:'Checkpoint 1 · 6 Minutes',title:'Explain the mechanism.',subtitle:'How did technology and monsoon knowledge enable Indian Ocean trade?',big:'06',
    ...
    {
      id:'markets',phase:'goods',kind:'map',eyebrow:'Commercial Exchange',title:'Markets made distance profitable.',subtitle:'Spices · Textiles · Gold · Ivory · Porcelain moved through cosmopolitan port cities.',
      layout:'image-forward',footer:'Markets connect goods, people, and information.',
    ...
    {
      id:'system-view',phase:'goods',kind:'split',eyebrow:'System View',title:'Goods, people, and ideas moved together.',subtitle:'Trade is the visible part of a larger human network.',
    ...
    {
      id:'ports',phase:'ports',kind:'process',eyebrow:'Trading Cities',title:'Ports become the network’s switching stations.',subtitle:'Swahili Coast city-states, Gujarat, and Malacca grew because they organized exchange.',
      steps:[{label:'Storage',text:'Warehouses hold goods while winds reverse'},{label:'Services',text:'Repair, lodging, food, markets'},{label:'Rules',text:'Taxes, brokers, interpreters, law'},{label:'Trust',text:'Worship, language, credit, contacts'}],footer:'A port grows rich by making merchants want to wait there.',
    ...
    {
      id:'diaspora',phase:'ports',kind:'map',eyebrow:'Diasporic Communities',title:'Merchants carried culture and absorbed culture.',subtitle:'Arab and Persian communities in East Africa · Chinese communities in Southeast Asia · Malay communities across the basin',
      layout:'image-forward',footer:'Diaspora = settle + connect + adapt + blend.',
    ...
    {
      id:'zheng-he',phase:'zhenghe',kind:'map',eyebrow:'State-Backed Maritime Contact',title:'Zheng He did not create the network. He sailed through one already mature.',subtitle:'Ming voyages show the scale, wealth, and political use of Indian Ocean connectivity.',
      layout:'image-forward',footer:'State power moved through an already mature maritime network.',
    ...
    {
      id:'beintheroom',phase:'room',kind:'split',layout:'action-visual',eyebrow:'BeInTheRoom · Kilwa',title:'Make the port decision.',subtitle:'You are in a Swahili Coast trading city. The winds, merchants, goods, and politics all matter.',big:'BR',
    ...
    {
      id:'contextualization',phase:'skill',kind:'action',eyebrow:'AP Skill Builder · Contextualization',title:'Start before 1200. Then explain what intensified.',subtitle:'Do not write as if the Indian Ocean appeared from nowhere.',big:'AP',
    ...
    {
      id:'causal-chain',retelling:true,phase:'synthesis',kind:'process',eyebrow:'Causal Chain',title:'Build the explanation, not the list.',subtitle:'Environment + technology + commercial practice -> trade growth -> state and cultural effects',
    ...
    {
      id:'check2',phase:'check2',kind:'action',eyebrow:'Final Checkpoint · 3 Minutes',title:'One cause. One effect. Specific evidence.',subtitle:'Use monsoons or technology for the cause. Use states, diasporas, or Zheng He for the effect.',big:'03',
