/* Topic 2.6 canonical teaching pipeline.
 ...
 */
document.write('<script src="data/topic-2-6-teaching-base.js"><\/script>');
document.write('<script src="data/topic-2-6-presentation-assets.js?v=data-v1"><\/script>');
document.write('<script src="data/topic-2-6-visual-assets.js?v=visuals-v1"><\/script>');
