/* Topic 2.5 canonical teaching pipeline.
 ...
 */
document.write('<script src="data/topic-2-5-teaching-base.js?v=pipeline-v1"><\/script>');
document.write('<script src="data/topic-2-5-presentation-assets.js?v=pipeline-v1"><\/script>');
