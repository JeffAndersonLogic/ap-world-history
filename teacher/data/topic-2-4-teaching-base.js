...
window.BEHISTORICAL_TEACHING = {
  ...
  slides: [
    ...
    {
      id:'goods-map',phase:'demand',kind:'frame-question',eyebrow:'The Motive · On the Map',title:'Follow the salt south and the gold north.',subtitle:'Every arrow is a price difference someone was willing to cross the desert for.',template:{},
