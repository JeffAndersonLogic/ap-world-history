...
window.BEHISTORICAL_TEACHING = {
  ...
  flow: [
    ...
    {id:'map',label:'Map the Network',range:'6–11',slide:3},
    {id:'first10',label:'First & 10',range:'11–21',slide:4},
    {id:'tools',label:'The Tools',range:'21–28',slide:5},
    {id:'demand',label:'Gold, Salt, and Price',range:'28–35',slide:7},
