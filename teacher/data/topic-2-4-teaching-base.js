...
window.BEHISTORICAL_TEACHING = {
  ...
  flow: [
    ...
    {id:'demand',label:'Gold, Salt, and Price',range:'27–34',slide:7},
    {id:'skill',label:'Why It Took Both',range:'34–45',slide:9},
    {id:'expand',label:'Volume + Range',range:'45–48',slide:11},
    {id:'check1',label:'Checkpoint 1',range:'48–54',slide:12},
    {id:'mali',label:'Mali + Mansa Musa',range:'54–69',slide:13},
    {id:'cities',label:'Djenné + Timbuktu',range:'69–76',slide:18},
    {id:'retell',label:'Retell',range:'76–80',slide:20},
    {id:'close',label:'Close + Bridge',range:'80–81',slide:21},
    {id:'check2',label:'Checkpoint 2 Work Time',range:'81–90',slide:21}
  ],
  quickLaunch: [
  ...
  slides: [
    ...
    {
      id:'hook',phase:'open',kind:'hero',eyebrow:'Topic 2.4 · The Question',title:'How did trade across the Sahara grow?',subtitle:'The desert never got any smaller. Hold that question: by the end of class you can answer it in one sentence.',position:'upper-left',
      notes:{minutes:2,land:['This is the topic question. Leave it up long enough for students to write it down.','Do not start with gold and salt. Start with the transportation problem: how do you move people and cargo across the Sahara again and again?','The picture is a modern photograph, and the riders on it are modern too. Use it for one thing only: the size and emptiness of the desert, which is the problem this whole lesson solves. The Catalan Atlas comes later, as evidence.'],story:'The core story is a chain of solutions. Camel technology and caravan organization reduce the transportation problem. Valuable demand makes the trip worth taking. Mali then gains power by sitting inside that exchange and helping organize it.',ask:'What has to be solved before a desert can become a trade route?',listenFor:'Water, carrying capacity, navigation, security, distance, profit.',ap:'Causation: identify the enabling conditions before explaining expansion.'}
    },
    {
      id:'basin',phase:'map',kind:'frame-question',eyebrow:'Module 01 · Map & Geography',title:'The Sahara is the problem in the middle.',subtitle:'West African gold zones · Saharan salt · North African markets',template:{},
      notes:{minutes:4,land:['The picture is a modern satellite image with no labels, so you do the labeling. Trace the tan band across the whole north of the continent: that is the Sahara. Then the green belt south of it, West Africa, where the gold is. Then the Mediterranean coast on the far side, where the buyers are.','Make the environmental scale visible before naming Mali: the desert is wider than the distance from the coast to the forest, and a caravan took about two months to cross it.','Hold the goods and the place names for the Mali map after Checkpoint 1. This slide is only the problem: two regions that need each other, with a desert between them.'],story:'This network connects complementary zones. West Africa has major gold production. Saharan deposits supply salt. North African and wider Islamic markets create additional demand and connections.',ask:'Why does geography create both the obstacle and the opportunity?',listenFor:'Distance and desert make movement hard, but different regions have valuable resources the others want.',ap:'Economic systems: regional specialization creates incentives for interregional exchange.'}
    },
    {
    ...
    {
      id:'mali-map',phase:'mali',kind:'frame-question',eyebrow:'Mali · On the Map',title:'Mali sits where the salt arrives and the gold leaves.',subtitle:'Follow the salt south from Taghaza and the gold north toward the Mediterranean.',template:{},
      notes:{minutes:2,land:['Locate the shaded Mali Empire, then Timbuktu, Djenné and Niani inside it. Then the North African cities at the other end of the routes: Fez, Tunis, Tripoli.','Point at Taghaza, then trace the salt arrow down to Walata and Timbuktu. Then trace gold the other way, toward the Mediterranean.','Read the arrows: gold, ivory and enslaved people moved north; salt, ceramics, glass and beads moved south. Say the enslaved people plainly. They were part of this trade. Salt and gold are the anchors, not the whole trade.'],story:'The satellite image at the start of class showed the problem. This map shows who ended up sitting across the answer: Mali\'s territory covers the southern end of the routes, where the caravans met the river and the gold fields.',ask:'Why is the southern edge of the desert the place to build an empire on this trade?',listenFor:'Every caravan has to arrive there; the gold fields and the Niger are there; whoever controls it can tax both directions of the trade.',ap:'Governance + economic systems: location on a trade network as a source of state power.'}
    },
    {
    ...
    {
      id:'mansa-musa',phase:'mali',kind:'frame-evidence',eyebrow:'Mansa Musa · 1324',title:'One pilgrimage advertises a whole network.',
      template:{sceneLabel:'A modern artist imagines the journey',evidenceLabel:'A map from 1375 records the reputation'},
      notes:{minutes:3,land:['Mansa Musa is evidence, not the whole topic. His hajj demonstrates wealth, mobility, Islam, and Mali\'s place in a wider interregional system.','Two pictures, two jobs. On the left, a modern painting by the American artist Higgins Bond: it imagines the pilgrimage, and nothing in it is evidence. On the right, the Catalan Atlas, drawn in Majorca about fifty years after the pilgrimage: its label calls Mansa Musa the richest king in the region because of the gold in his land.','Ask which one a historian can use, and why. The answer is the map, and not because it is more accurate about his face: it is evidence of what Mediterranean mapmakers knew and believed about Mali in 1375.','The Catalan Atlas is a Mediterranean representation of Mali\'s ruler and wealth; treat it as evidence of reputation and geographic knowledge, not a portrait from life.','Al-Umari, writing in Cairo about a dozen years after the visit, reported that Musa\'s spending there lowered the value of gold. Use that as the BeSurreal fact, not as the lesson.'],story:'The hajj connects West African imperial wealth to North Africa, the Middle East, and the wider Islamic world. It makes the network visible to distant observers.',ask:'Which of these two pictures can a historian use as evidence, and evidence of what?',listenFor:'The map, as evidence of Mali\'s reputation and reach in 1375; the painting is an artist\'s interpretation made centuries later.',ap:'Sourcing: a later artwork interprets; a contemporary source is evidence of what its makers knew and believed.'}
    },
    {
      id:'mansa-musa-video',phase:'mali',kind:'video',eyebrow:'Video · TED-Ed · Mansa Musa',title:'Mansa Musa, one of the wealthiest people who ever lived',footer:'Where did his wealth come from? Connect it to the gold and salt trade.',
      video:{youtubeId:'O3YJMaL55TM',label:'Mansa Musa, one of the wealthiest people who ever lived - Jessica Smith (TED-Ed)'},
      notes:{minutes:4,land:['Give the question before you press play: where did the wealth come from? The answer is the gold fields and the trade routes Mali sat across, not Mansa Musa himself.','Treat the big numbers in the clip (people, camels, gold) as reputation. They come from Arabic writers such as al-Umari, reporting what Cairo remembered, which is the same kind of evidence as the Catalan Atlas on the last slide.','“Wealthiest person who ever lived” is a modern claim no one can measure. What the sources can show is that his wealth was famous across the Islamic world.'],story:'The clip turns the hajj into a story students remember. The lesson\'s job is to connect it back: the gold that made the pilgrimage famous came out of the same network the saddles and caravans built.',ask:'Where did Mansa Musa\'s wealth come from, and what does his journey to Mecca show about how far the trade network reached?',listenFor:'Gold from West African fields, taxed trade on the routes; the hajj made Mali known in Cairo, Mecca and the Mediterranean.',ap:'Sourcing + causation: the hajj is evidence of Mali\'s wealth and reach, caused by its place in the trade.'}
    },
    {
      ...
      notes:{minutes:2,land:['Use Djenné, a major trading city of the Mali era, as evidence of urban and Islamic connections supported by wider trade, not as a claim that trade alone created every institution.','Say that the present mosque is a 1907 building on the site of earlier mosques, so it shows the city\'s lasting Islamic importance rather than its exact 14th-century form. Timbuktu is the other city to name, and the next slide is its video.','Arabic literacy, scholarship, and Islam connect Mali to a broader religious and intellectual world.'],story:'Commercial routes carry more than commodities. They create durable contact zones where political, religious, and intellectual institutions can deepen.',ask:'How can a trade route change a city even when the goods keep moving through it?',listenFor:'Taxes, markets, visitors, scholars, religious institutions, services.',ap:'Effects of exchange: urban growth and cultural connection.'}
    },
    {
      id:'timbuktu-video',phase:'mali',kind:'video',eyebrow:'Video · TED-Ed · Timbuktu',title:'The hidden treasures of Timbuktu',footer:'Name one thing, besides gold and salt, that traveled along the caravan routes.',
      video:{youtubeId:'40ehHbdi95o',label:'The hidden treasures of Timbuktu - Elizabeth Cox (TED-Ed)'},
      notes:{minutes:5,land:['Give the question before you press play: what besides gold and salt traveled the caravan routes? Listen for books, scholars and Islam.','Watch the dates. If the clip moves past Mali into Songhay or later centuries, say so: Timbuktu\'s learning outlasted the empire that first made it rich, which is the landing slide\'s point about states rising and falling while the trade kept going.','Keep the claim causal: caravans brought the wealth, the paper and the scholars that made Timbuktu a center of Islamic learning.'],story:'Trade routes carry more than commodities. Timbuktu is the case where a trading city became a center of scholarship because the caravans kept bringing books and people.',ask:'How did trans-Saharan trade turn Timbuktu into a center of Islamic learning?',listenFor:'Books and manuscripts, scholars and students, Islam and Arabic literacy traveled with the merchants; trade wealth paid for mosques and teachers.',ap:'Effects of exchange: cultural and intellectual connection carried by a commercial network.'}
    },
    {
