...
window.BEHISTORICAL_TEACHING = {
  ...
  slides: [
    ...
    {
      id:'goods-map',phase:'demand',kind:'map',eyebrow:'The Motive · On the Map',title:'Follow the salt south and the gold north.',footer:'Every arrow is a price difference someone was willing to cross the desert for.',
      notes:{minutes:1,land:['Point at Taghaza, then trace the salt arrow down to Walata and Timbuktu. Then trace gold the other way, toward the Mediterranean.','Name what else moves on the map: cloth, beads, copper, and enslaved people. Salt and gold are the anchors, not the whole trade.'],story:'The map is the diagram from the last slide drawn onto real places: each region sends what it has and receives what it lacks.',ask:'Which town sits where the salt arrives and the gold leaves?',listenFor:'Timbuktu, Walata or Gao: the Sahel edge, where caravans met river and road.',ap:'Economic systems: regional specialization made visible on a map.'}
    },
    {
    ...
    {
      id:'landing',phase:'close',kind:'map',eyebrow:'Topic 2.4 · The Big Idea',title:'The Sahara did not shrink.',subtitle:'The system for crossing it got better, and a trade route became an empire\'s foundation.',footer:'Ghana, then Mali, then Songhay: the empires changed, and the routes stayed.',
      notes:{minutes:1,land:['Land the single idea: the environment remains difficult; human systems change what is possible inside it.','Point at the three shaded empires. Ghana came before Mali and Songhay after it, and the purple routes run through all three. The states rose and fell; the trade that paid for them kept going.','Bridge forward to Topic 2.5: once networks intensify, ideas, technologies, religions and people move with the goods. Islam crossed the Sahara on these caravans.'],story:'Trade expands when societies solve enough of the transportation problem for demand and political organization to do the rest.',ask:'What is the one sentence you need to remember tomorrow?',listenFor:'Tools and demand → more trade → Mali grows by protecting and taxing it.',ap:'Bridge to cultural consequences of connectivity.'}
    }
  ]
};
