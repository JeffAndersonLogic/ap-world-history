...
synthesis.retelling=true;synthesis.phase='skill';synthesis.kind='process';synthesis.eyebrow='AP Synthesis';synthesis.title='State Change -> Pax Mongolica -> Transfer -> Significance';synthesis.steps=[
