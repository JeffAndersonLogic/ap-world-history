...
(function(){
  ...
  function styles(){
    return `
      ...
      @media(max-width:900px){.compare-grid,.video-wrap,.grid,.steps{grid-template-columns:1fr}.map-label{position:static;transform:none;margin-top:.5vh}.evidence-band{grid-template-columns:1fr}.evidence-band .credit{text-align:left}.compare-slide{overflow:auto}.compare-panel{min-height:36vh}.reconstruction-footer{align-items:flex-start;flex-direction:column;gap:.45vh}.reconstruction-footer .credit{text-align:left}}
    `;
  }
