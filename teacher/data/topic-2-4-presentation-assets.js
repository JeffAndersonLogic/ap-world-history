 ...
 * Later that day he put a satellite image of Africa on the Map & Geography
 * slide and moved the Mali map to its own slide after Checkpoint 1. Both are
 * on frame-question with fit:'contain', so neither picture is cropped.
...
const SATELLITE={fit:'contain',url:local('2.4 - Africa Satellite.jpg'),alt:'Satellite image of Africa: the tan Sahara across the north, green West and Central Africa to the south, the Mediterranean above',credit:'Satellite image · Africa'};
...
const TEMPLATE_VISUALS={
  'basin':{visual:SATELLITE},
  'mali-map':{visual:GOODS_MAP},
  'taghaza':{visual:SALT},
