...
window.BEHISTORICAL_TEACHING = {
  ...
  slides: [
    ...
    {
      phase:'zhenghe',kind:'hero',eyebrow:'State-Backed Maritime Contact',title:'Zheng He did not create the network. He sailed through one already mature.',subtitle:'Ming voyages show the scale, wealth, and political use of Indian Ocean connectivity.',
      visual:{url:BH23.zhengHe,alt:'Zheng He fleet sailing through the Indian Ocean',credit:'BeHistorical visual · Zheng He fleet'},
