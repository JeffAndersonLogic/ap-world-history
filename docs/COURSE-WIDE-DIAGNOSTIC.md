# Course-Wide BeHistorical Diagnostic

**Purpose:** a read-only risk map using the Unit 2 reference-standard categories before any mass repair. This is **not** a blanket CED certification. It identifies where deeper CED/source review and human instructional review should be concentrated.

## Calibration

Known-good control: certified Unit 2 must return CLEAN on all seven topics. Control PASS. The framework was also calibrated on Topic 3.2 (early-course land-empire administration) and Topic 8.4 (late-course dual-objective communism/redistribution). Overall calibration PASS.
...
| 1.6 | Developments in Europe | **CLEAN** | No automated structural flags | 100% |
| 1.7 | Comparison in the Period from c. 1200 to c. 1450 | **REVIEW** | Review: no BeInTheRoom scenario linked | 100% |
| 2.1 | The Silk Roads | **CLEAN** | No automated structural flags | 80% |
| 2.2 | The Mongol Empire | **CLEAN** | No automated structural flags | 0% |
| 2.3 | Exchange in the Indian Ocean | **CLEAN** | No automated structural flags | 67% |
| 2.4 | Trans-Saharan Trade Routes | **CLEAN** | No automated structural flags | 100% |
| 2.5 | Cultural Consequences of Connectivity | **CLEAN** | No automated structural flags | 38% |
| 2.6 | Environmental Consequences of Connectivity | **CLEAN** | No automated structural flags | 67% |
...
| 6.3 | Indigenous Responses to State Expansion | **CLEAN** | No automated structural flags | 9% |
| 6.4 | Global Economic Development | **CLEAN** | No automated structural flags | 0% |
| 6.5 | Economic Imperialism | **CLEAN** | No automated structural flags | 0% |
...
| 9.6 | Globalized Culture After 1900 | **CLEAN** | No automated structural flags | 0% |
| 9.7 | Resistance to Globalization After 1900 | **CLEAN** | No automated structural flags | 50% |
| 9.8 | Institutions Developing in a Globalized World | **CLEAN** | No automated structural flags | 100% |
| 9.9 | Continuity and Change in a Globalized World | **REVIEW** | Review: no BeInTheRoom scenario linked | 100% |

## How to interpret this report

- **REBUILD:** multiple structural/contract failures. Deep audit before teaching.
- **REPAIR:** at least one major break or several coherence risks. Repair before Teaching OS conversion.
- **REVIEW:** structure is present, but one or more drift/source-of-truth signals need a human/CED check.
- **CLEAN:** no automated structural flags. This does **not** replace human instructional review or independent CED verification.

## Next audit pass

1. Deep CED/instructional audits are complete for Units 1 and 3–9; Unit 2 remains the certified reference implementation. Human findings supersede automated CLEAN labels.
2. Begin repair with the highest-risk topic-role mismatches, especially Units 4 and 5, while repairing Unit 3 before it is taught.
3. After each unit is repaired and human-reviewed, convert its verified spine into locked CED/coherence contracts so future changes are caught automatically.
4. Keep human instructional review separate from automated certification.

Generated by node scripts/audit-course.js.
