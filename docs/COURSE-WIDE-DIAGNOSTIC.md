...
1. Deep-audit Unit 3 first, using the actual CED governing source and the five-part Unit 2 standard.
2. Then deep-audit every REBUILD/REPAIR topic course-wide, regardless of unit order.
3. Convert verified topic spines into locked per-unit CED/coherence contracts, so future changes are caught automatically.
