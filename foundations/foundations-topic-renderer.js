...
const BHDraftStore=(function(){
  ...
  // Phase 1 instrumentation, mirroring the unit renderer. Counts whether a
  // save worked, never what was written. See assets/js/behistorical-save-health.js.
  ...
  return {
    ...
    set(key,value){
      ...
      try{
        ...
        if(window.BHSaveHealth)window.BHSaveHealth.recordWrite(true);
        return true;
      }catch(e){
        live=false;
