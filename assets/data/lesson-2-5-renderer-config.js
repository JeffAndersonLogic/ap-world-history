(() => {
  ...
  lesson.images = [
  { title: 'Great Buddha at the Mogao Caves, Dunhuang, 695', url: 'https://commons.wikimedia.org/wiki/Special:FilePath/Great_Buddha,_Cave_96,_Mogao_Caves.jpg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Great_Buddha,_Cave_96,_Mogao_Caves.jpg', caption: 'Religious-diffusion evidence. This Buddha was carved in 695 at the Mogao Caves, in the Silk Road oasis of Dunhuang, five centuries before this period. It shows that Buddhism had already traveled the Silk Roads and was established in China long before the networks grew after 1200.', prompt: 'NOTICE the scale and religious imagery. What can you INFER about Buddhism’s presence at a trade-route oasis? What evidence would you need to prove how merchants, rulers, and monks each contributed to diffusion?' },
