...
window.BEHISTORICAL_LESSON = {
  ...
  lecture: {
    ...
    videos: [
      {
        title: "RESISTANCE to Power Structures After 1900 [AP World History Review, Unit 8 Topic 7]",
        url: "https://youtu.be/p_zjyvCB3Ek",
        youtubeId: "p_zjyvCB3Ek",
    ...
    segments: [
      ...
      },
      {
        ...
        image: {
          ...
          url: "https://commons.wikimedia.org/wiki/Special:FilePath/Zones_registering_Sendero_Luminoso_%28Shining_Path%29_activity.svg",
          sourceUrl: "https://commons.wikimedia.org/wiki/File:Zones_registering_Sendero_Luminoso_%28Shining_Path%29_activity.svg"
        }
      }
    ]
  },
  ...
  skillBuilder: {
    ...
    prompt: "Write a two-paragraph response: (1) explain which KC category the contested ANC case belongs to, using specific evidence to defend your placement, what about the ANC's methods supports your categorization? (2) explain what the ANC case reveals about the AP Learning Objective, why does the learning objective ask you to explain 'various' reactions rather than to sort them into clean boxes? What does the difficulty of categorizing the ANC reveal about how reactions to power actually work in history?"
  }
