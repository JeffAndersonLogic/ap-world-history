...
(() => {
  ...
  lesson.first10 = {
    ...
    embedUrl: 'first-and-10-topic-7-1-shifting-power-capture.html?v=response-id-fix-v1',
  ...
  lesson.stableImages = {
    ...
    checkpoint1: 'https://commons.wikimedia.org/wiki/Special:FilePath/Kemal_Atat%C3%BCrk_portrait.jpg',
