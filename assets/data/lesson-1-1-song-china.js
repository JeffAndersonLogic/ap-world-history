...
window.BEHISTORICAL_LESSON = {
  ...
  lecture: {
    ...
    videos: [
      { title: "Developments in EAST ASIA [AP World Review Unit 1 Topic 1]", url: "https://youtu.be/HfIWZhXt7fY", youtubeId: "HfIWZhXt7fY", prompt: "Use this clip to review Song governance, Confucianism, and cultural influence across East Asia." },
      { title: "State Building in SONG CHINA [AP World History Review, Unit 1 Topic 1]", url: "https://youtu.be/Wc1YgOeVEwI", youtubeId: "Wc1YgOeVEwI", prompt: "Heimler's newer take on the same topic. Use it to review how the Song state was built and how Champa rice, the Grand Canal, and paper money grew the economy." }
    ],
    segments: [
      ...
      { title: "Why the Song economy expanded", bullets: ["Champa rice increased agricultural productivity and supported population growth.", "The **Grand Canal** connected northern and southern China and helped move grain, goods, and tax revenue.", "Paper money, iron and steel production, porcelain, textiles, and urban markets reveal a highly commercialized economy."], image: { title: "Map of the Grand Canal", caption: "The Grand Canal linked northern and southern China, moving grain, goods, and tax revenue across the empire.", url: "https://commons.wikimedia.org/wiki/Special:FilePath/Modern_Course_of_Grand_Canal_of_China.png", sourceUrl: "https://commons.wikimedia.org/wiki/File:Modern_Course_of_Grand_Canal_of_China.png" } }
    ]
  },
  ...
  primarySource: {
    ...
    attribution: "Fan Zhongyan, memorial to Emperor Renzong, \"Memorial to the Throne on Ten Matters of Reform\" (Shitiao Shu), 1043 CE",
