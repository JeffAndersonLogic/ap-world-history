...
(() => {
  ...
  lesson.first10 = {
    ...
    embedUrl: 'first-and-10-topic-7-6-causes-wwii-capture.html?v=response-id-fix-v1',
  ...
  lesson.stableImages = {
    ...
    beInTheRoom: 'https://commons.wikimedia.org/wiki/Special:FilePath/MunichAgreement.jpg',
