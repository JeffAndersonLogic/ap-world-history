...
(() => {
  ...
  lesson.first10 = {
    ...
    embedUrl: 'first-and-10-topic-7-3-conducting-wwi-capture.html?v=response-id-fix-v1',
  ...
  lesson.stableImages = {
    ...
    source: 'https://commons.wikimedia.org/wiki/Special:FilePath/John_Singer_Sargent_-_Gassed%2C_an_oil_study.jpg',
