  ...
  lecture: {
    ...
    segments: [
      ...
      },
      {
        title: "Two Roads Out",
        bullets: [
          "After World War II, two distinct paths to independence emerged. The CED captures the comparison precisely: 'some colonies negotiated their independence, while others achieved independence through armed struggle.' The learning objective asks you to compare these processes, not just list the cases, but explain what drove each colony down one road or the other.",
